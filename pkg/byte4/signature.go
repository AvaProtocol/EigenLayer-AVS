...
// GetMethodFromSelector returns the method name and ABI method for a given 4-byte selector
func GetMethodFromSelector(parsedABI abi.ABI, selector []byte) (*abi.Method, error) {
	if len(selector) < 4 {
