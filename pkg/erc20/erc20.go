...
func (_Erc20 *Erc20Caller) UPGRADEINTERFACEVERSION(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Erc20.contract.Call(opts, &out, "UPGRADE_INTERFACE_VERSION")
...
//
// Solidity: function UPGRADE_INTERFACE_VERSION() view returns(string)
func (_Erc20 *Erc20Session) UPGRADEINTERFACEVERSION() (string, error) {
	return _Erc20.Contract.UPGRADEINTERFACEVERSION(&_Erc20.CallOpts)
}

// UPGRADEINTERFACEVERSION is a free data retrieval call binding the contract method 0xad3cb1cc.
//
// Solidity: function UPGRADE_INTERFACE_VERSION() view returns(string)
func (_Erc20 *Erc20CallerSession) UPGRADEINTERFACEVERSION() (string, error) {
	return _Erc20.Contract.UPGRADEINTERFACEVERSION(&_Erc20.CallOpts)
}
...
func (_Erc20 *Erc20Caller) ProxiableUUID(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Erc20.contract.Call(opts, &out, "proxiableUUID")
...
//
// Solidity: function proxiableUUID() view returns(bytes32)
func (_Erc20 *Erc20Session) ProxiableUUID() ([32]byte, error) {
	return _Erc20.Contract.ProxiableUUID(&_Erc20.CallOpts)
}

// ProxiableUUID is a free data retrieval call binding the contract method 0x52d1902d.
//
// Solidity: function proxiableUUID() view returns(bytes32)
func (_Erc20 *Erc20CallerSession) ProxiableUUID() ([32]byte, error) {
	return _Erc20.Contract.ProxiableUUID(&_Erc20.CallOpts)
}
...
func (_Erc20 *Erc20Transactor) Initialize(opts *bind.TransactOpts, initialOwner common.Address) (*types.Transaction, error) {
	return _Erc20.contract.Transact(opts, "initialize", initialOwner)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address initialOwner) returns()
func (_Erc20 *Erc20Session) Initialize(initialOwner common.Address) (*types.Transaction, error) {
	return _Erc20.Contract.Initialize(&_Erc20.TransactOpts, initialOwner)
}

// Initialize is a paid mutator transaction binding the contract method 0xc4d66de8.
//
// Solidity: function initialize(address initialOwner) returns()
func (_Erc20 *Erc20TransactorSession) Initialize(initialOwner common.Address) (*types.Transaction, error) {
	return _Erc20.Contract.Initialize(&_Erc20.TransactOpts, initialOwner)
}
...
func (_Erc20 *Erc20Filterer) FilterUpgraded(opts *bind.FilterOpts, implementation []common.Address) (*Erc20UpgradedIterator, error) {
	...
	logs, sub, err := _Erc20.contract.FilterLogs(opts, "Upgraded", implementationRule)
	if err != nil {
		return nil, err
	}
...
//
// Solidity: event Upgraded(address indexed implementation)
func (_Erc20 *Erc20Filterer) WatchUpgraded(opts *bind.WatchOpts, sink chan<- *Erc20Upgraded, implementation []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Erc20.contract.WatchLogs(opts, "Upgraded", implementationRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
