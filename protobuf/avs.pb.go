...
func (*Evm_Log) Descriptor() ([]byte, []int) {
	return file_protobuf_avs_proto_rawDescGZIP(), []int{50, 0}
}
...
func (*Evm_TransactionReceipt) Descriptor() ([]byte, []int) {
	return file_protobuf_avs_proto_rawDescGZIP(), []int{50, 1}
}
...
func (*Evm_UserOp) Descriptor() ([]byte, []int) {
	return file_protobuf_avs_proto_rawDescGZIP(), []int{50, 2}
}
...
var file_protobuf_avs_proto_msgTypes = make([]protoimpl.MessageInfo, 72)
...
func file_protobuf_avs_proto_init() {
	...
	file_protobuf_avs_proto_msgTypes[5].OneofWrappers = []any{
	...
	file_protobuf_avs_proto_msgTypes[15].OneofWrappers = []any{
	...
	file_protobuf_avs_proto_msgTypes[17].OneofWrappers = []any{
