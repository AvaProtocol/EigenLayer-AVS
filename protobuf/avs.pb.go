...
var file_protobuf_avs_proto_rawDesc = []byte{
	...
	0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x10, 0x01, 0x32, 0x9e, 0x03, 0x0a, 0x0b, 0x41, 0x67, 0x67,
	0x72, 0x65, 0x67, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x12, 0x36, 0x0a, 0x06, 0x47, 0x65, 0x74, 0x4b,
	...
	0x54, 0x61, 0x73, 0x6b, 0x73, 0x52, 0x65, 0x73, 0x70, 0x22, 0x00, 0x12, 0x3c, 0x0a, 0x0a, 0x43,
...
var file_protobuf_avs_proto_msgTypes = make([]protoimpl.MessageInfo, 19)
var file_protobuf_avs_proto_goTypes = []interface{}{
	...
	(*AddressRequest)(nil),             // 12: aggregator.AddressRequest
	(*AddressResp)(nil),                // 13: aggregator.AddressResp
	(*ListTasksReq)(nil),               // 14: aggregator.ListTasksReq
	(*ListTasksResp)(nil),              // 15: aggregator.ListTasksResp
	(*GetKeyReq)(nil),                  // 16: aggregator.GetKeyReq
	(*KeyResp)(nil),                    // 17: aggregator.KeyResp
	(*Checkin_Status)(nil),             // 18: aggregator.Checkin.Status
	(*TaskTrigger_TimeCondition)(nil),  // 19: aggregator.TaskTrigger.TimeCondition
	(*ListTasksResp_TaskItemResp)(nil), // 20: aggregator.ListTasksResp.TaskItemResp
	(*timestamppb.Timestamp)(nil),      // 21: google.protobuf.Timestamp
	(*wrapperspb.BoolValue)(nil),       // 22: google.protobuf.BoolValue
}
var file_protobuf_avs_proto_depIdxs = []int32{
	21, // 0: aggregator.Checkin.last_updated:type_name -> google.protobuf.Timestamp
	...
	19, // 4: aggregator.TaskTrigger.schedule:type_name -> aggregator.TaskTrigger.TimeCondition
	...
	20, // 8: aggregator.ListTasksResp.tasks:type_name -> aggregator.ListTasksResp.TaskItemResp
	21, // 9: aggregator.Checkin.Status.last_fetched:type_name -> google.protobuf.Timestamp
	16, // 10: aggregator.Aggregrator.GetKey:input_type -> aggregator.GetKeyReq
	10, // 11: aggregator.Aggregrator.GetNonce:input_type -> aggregator.NonceRequest
	12, // 12: aggregator.Aggregrator.GetSmartAccountAddress:input_type -> aggregator.AddressRequest
	8,  // 13: aggregator.Aggregrator.CreateTask:input_type -> aggregator.CreateTaskReq
	14, // 14: aggregator.Aggregrator.ListTasks:input_type -> aggregator.ListTasksReq
	2,  // 15: aggregator.Aggregrator.CancelTask:input_type -> aggregator.UUID
	17, // 16: aggregator.Aggregrator.GetKey:output_type -> aggregator.KeyResp
	11, // 17: aggregator.Aggregrator.GetNonce:output_type -> aggregator.NonceResp
	13, // 18: aggregator.Aggregrator.GetSmartAccountAddress:output_type -> aggregator.AddressResp
	9,  // 19: aggregator.Aggregrator.CreateTask:output_type -> aggregator.CreateTaskResp
	15, // 20: aggregator.Aggregrator.ListTasks:output_type -> aggregator.ListTasksResp
	22, // 21: aggregator.Aggregrator.CancelTask:output_type -> google.protobuf.BoolValue
