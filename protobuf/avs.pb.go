...
const file_avs_proto_rawDesc = "" +
	...
	"workflowId\x12\x15\n" +
	"\x06org_id\x18\x04 \x01(\tR\x05orgId\"1\n" +
	"\x0eListSecretsReq\x12\x1f\n" +
	"\vworkflow_id\x18\x01 \x01(\tR\n" +
	"workflowId\"\xc7\x01\n" +
	"\x0fListSecretsResp\x12@\n" +
	"\x05items\x18\x01 \x03(\v2*.aggregator.ListSecretsResp.ResponseSecretR\x05items\x1ar\n" +
