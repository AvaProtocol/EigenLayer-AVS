...
type TaskTrigger struct {
	...
	// Input data that can be referenced by subsequent nodes as trigger_name.input
	Input *_struct.Value `protobuf:"bytes,9,opt,name=input,proto3" json:"input,omitempty"`
...
func (x *TaskTrigger) GetInput() *_struct.Value {
	if x != nil {
		return x.Input
	}
	return nil
...
type TaskNode struct {
	...
	// Input data that can be referenced by subsequent nodes as node_name.input
	Input *_struct.Value `protobuf:"bytes,4,opt,name=input,proto3" json:"input,omitempty"`
...
func (x *TaskNode) GetInput() *_struct.Value {
	if x != nil {
		return x.Input
	}
	return nil
...
type RunNodeWithInputsReq struct {
	...
	NodeConfig     map[string]*_struct.Value `protobuf:"bytes,2,rep,name=node_config,json=nodeConfig,proto3" json:"node_config,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`             // Configuration for the node
	InputVariables map[string]*_struct.Value `protobuf:"bytes,3,rep,name=input_variables,json=inputVariables,proto3" json:"input_variables,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // Input variables for the node
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *RunNodeWithInputsReq) GetNodeConfig() map[string]*_struct.Value {
	if x != nil {
		return x.NodeConfig
	}
	return nil
...
func (x *RunNodeWithInputsReq) GetInputVariables() map[string]*_struct.Value {
	if x != nil {
...
type RunTriggerReq struct {
	...
	TriggerConfig map[string]*_struct.Value `protobuf:"bytes,2,rep,name=trigger_config,json=triggerConfig,proto3" json:"trigger_config,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // Configuration for the trigger
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *RunTriggerReq) GetTriggerConfig() map[string]*_struct.Value {
	if x != nil {
...
type SimulateTaskReq struct {
	...
	InputVariables map[string]*_struct.Value `protobuf:"bytes,6,rep,name=input_variables,json=inputVariables,proto3" json:"input_variables,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // Input variables for the simulation
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *SimulateTaskReq) GetInputVariables() map[string]*_struct.Value {
	if x != nil {
		return x.InputVariables
	}
	return nil
...
func (x *RestAPINode_Output) GetData() *_struct.Value {
	if x != nil {
		return x.Data
	}
	return nil
...
const file_avs_proto_rawDesc = "" +
	...
	"\x14max_events_per_block\x18\x03 \x01(\rH\x00R\x11maxEventsPerBlock\x88\x01\x01B\x17\n" +
	...
	"\x04type\x18\b \x01(\x0e2\x17.aggregator.TriggerTypeR\x04type\x12,\n" +
	"\x05input\x18\t \x01(\v2\x16.google.protobuf.ValueR\x05input\x12\x18\n" +
...
var file_avs_proto_goTypes = []any{
	...
	(*EventTrigger_Topics)(nil),                           // 76: aggregator.EventTrigger.Topics
	(*EventTrigger_Config)(nil),                           // 77: aggregator.EventTrigger.Config
	(*EventTrigger_Output)(nil),                           // 78: aggregator.EventTrigger.Output
	(*EventTrigger_TransferLogOutput)(nil),                // 79: aggregator.EventTrigger.TransferLogOutput
	...
	(*Evm_Log)(nil),                                       // 117: aggregator.Evm.Log
	(*Evm_TransactionReceipt)(nil),                        // 118: aggregator.Evm.TransactionReceipt
	(*Evm_UserOp)(nil),                                    // 119: aggregator.Evm.UserOp
	nil,                                                   // 120: aggregator.SimulateTaskReq.InputVariablesEntry
	(*_struct.Value)(nil),                                 // 121: google.protobuf.Value
	(*any1.Any)(nil),                                      // 122: google.protobuf.Any
...
var file_avs_proto_depIdxs = []int32{
	...
	71,  // 2: aggregator.CronTrigger.config:type_name -> aggregator.CronTrigger.Config
	73,  // 3: aggregator.BlockTrigger.config:type_name -> aggregator.BlockTrigger.Config
	77,  // 4: aggregator.EventTrigger.config:type_name -> aggregator.EventTrigger.Config
	80,  // 5: aggregator.ManualTrigger.config:type_name -> aggregator.ManualTrigger.Config
	0,   // 6: aggregator.TaskTrigger.type:type_name -> aggregator.TriggerType
	121, // 7: aggregator.TaskTrigger.input:type_name -> google.protobuf.Value
	10,  // 8: aggregator.TaskTrigger.fixed_time:type_name -> aggregator.FixedTimeTrigger
	11,  // 9: aggregator.TaskTrigger.cron:type_name -> aggregator.CronTrigger
	12,  // 10: aggregator.TaskTrigger.block:type_name -> aggregator.BlockTrigger
	13,  // 11: aggregator.TaskTrigger.event:type_name -> aggregator.EventTrigger
	82,  // 12: aggregator.ETHTransferNode.config:type_name -> aggregator.ETHTransferNode.Config
	84,  // 13: aggregator.ContractWriteNode.config:type_name -> aggregator.ContractWriteNode.Config
	94,  // 14: aggregator.ContractReadNode.config:type_name -> aggregator.ContractReadNode.Config
	98,  // 15: aggregator.GraphQLQueryNode.config:type_name -> aggregator.GraphQLQueryNode.Config
	101, // 16: aggregator.RestAPINode.config:type_name -> aggregator.RestAPINode.Config
	104, // 17: aggregator.CustomCodeNode.config:type_name -> aggregator.CustomCodeNode.Config
	107, // 18: aggregator.BranchNode.config:type_name -> aggregator.BranchNode.Config
	109, // 19: aggregator.FilterNode.config:type_name -> aggregator.FilterNode.Config
	16,  // 20: aggregator.LoopNode.eth_transfer:type_name -> aggregator.ETHTransferNode
	17,  // 21: aggregator.LoopNode.contract_write:type_name -> aggregator.ContractWriteNode
	18,  // 22: aggregator.LoopNode.contract_read:type_name -> aggregator.ContractReadNode
	19,  // 23: aggregator.LoopNode.graphql_data_query:type_name -> aggregator.GraphQLQueryNode
	20,  // 24: aggregator.LoopNode.rest_api:type_name -> aggregator.RestAPINode
	21,  // 25: aggregator.LoopNode.custom_code:type_name -> aggregator.CustomCodeNode
	111, // 26: aggregator.LoopNode.config:type_name -> aggregator.LoopNode.Config
	1,   // 27: aggregator.TaskNode.type:type_name -> aggregator.NodeType
	121, // 28: aggregator.TaskNode.input:type_name -> google.protobuf.Value
	16,  // 29: aggregator.TaskNode.eth_transfer:type_name -> aggregator.ETHTransferNode
	17,  // 30: aggregator.TaskNode.contract_write:type_name -> aggregator.ContractWriteNode
	18,  // 31: aggregator.TaskNode.contract_read:type_name -> aggregator.ContractReadNode
	19,  // 32: aggregator.TaskNode.graphql_query:type_name -> aggregator.GraphQLQueryNode
	20,  // 33: aggregator.TaskNode.rest_api:type_name -> aggregator.RestAPINode
	22,  // 34: aggregator.TaskNode.branch:type_name -> aggregator.BranchNode
	23,  // 35: aggregator.TaskNode.filter:type_name -> aggregator.FilterNode
	24,  // 36: aggregator.TaskNode.loop:type_name -> aggregator.LoopNode
	21,  // 37: aggregator.TaskNode.custom_code:type_name -> aggregator.CustomCodeNode
	113, // 38: aggregator.Execution.steps:type_name -> aggregator.Execution.Step
	4,   // 39: aggregator.Task.status:type_name -> aggregator.TaskStatus
	15,  // 40: aggregator.Task.trigger:type_name -> aggregator.TaskTrigger
	26,  // 41: aggregator.Task.nodes:type_name -> aggregator.TaskNode
	25,  // 42: aggregator.Task.edges:type_name -> aggregator.TaskEdge
	15,  // 43: aggregator.CreateTaskReq.trigger:type_name -> aggregator.TaskTrigger
	26,  // 44: aggregator.CreateTaskReq.nodes:type_name -> aggregator.TaskNode
	25,  // 45: aggregator.CreateTaskReq.edges:type_name -> aggregator.TaskEdge
	34,  // 46: aggregator.ListWalletResp.items:type_name -> aggregator.SmartWallet
	28,  // 47: aggregator.ListTasksResp.items:type_name -> aggregator.Task
	51,  // 48: aggregator.ListTasksResp.page_info:type_name -> aggregator.PageInfo
	27,  // 49: aggregator.ListExecutionsResp.items:type_name -> aggregator.Execution
	51,  // 50: aggregator.ListExecutionsResp.page_info:type_name -> aggregator.PageInfo
	5,   // 51: aggregator.ExecutionStatusResp.status:type_name -> aggregator.ExecutionStatus
	0,   // 52: aggregator.TriggerTaskReq.trigger_type:type_name -> aggregator.TriggerType
	74,  // 53: aggregator.TriggerTaskReq.block_trigger:type_name -> aggregator.BlockTrigger.Output
	70,  // 54: aggregator.TriggerTaskReq.fixed_time_trigger:type_name -> aggregator.FixedTimeTrigger.Output
	72,  // 55: aggregator.TriggerTaskReq.cron_trigger:type_name -> aggregator.CronTrigger.Output
	78,  // 56: aggregator.TriggerTaskReq.event_trigger:type_name -> aggregator.EventTrigger.Output
	81,  // 57: aggregator.TriggerTaskReq.manual_trigger:type_name -> aggregator.ManualTrigger.Output
	5,   // 58: aggregator.TriggerTaskResp.status:type_name -> aggregator.ExecutionStatus
	52,  // 59: aggregator.ListSecretsResp.items:type_name -> aggregator.Secret
	51,  // 60: aggregator.ListSecretsResp.page_info:type_name -> aggregator.PageInfo
	1,   // 61: aggregator.RunNodeWithInputsReq.node_type:type_name -> aggregator.NodeType
	114, // 62: aggregator.RunNodeWithInputsReq.node_config:type_name -> aggregator.RunNodeWithInputsReq.NodeConfigEntry
	115, // 63: aggregator.RunNodeWithInputsReq.input_variables:type_name -> aggregator.RunNodeWithInputsReq.InputVariablesEntry
	83,  // 64: aggregator.RunNodeWithInputsResp.eth_transfer:type_name -> aggregator.ETHTransferNode.Output
	99,  // 65: aggregator.RunNodeWithInputsResp.graphql:type_name -> aggregator.GraphQLQueryNode.Output
	96,  // 66: aggregator.RunNodeWithInputsResp.contract_read:type_name -> aggregator.ContractReadNode.Output
	86,  // 67: aggregator.RunNodeWithInputsResp.contract_write:type_name -> aggregator.ContractWriteNode.Output
	105, // 68: aggregator.RunNodeWithInputsResp.custom_code:type_name -> aggregator.CustomCodeNode.Output
	102, // 69: aggregator.RunNodeWithInputsResp.rest_api:type_name -> aggregator.RestAPINode.Output
	108, // 70: aggregator.RunNodeWithInputsResp.branch:type_name -> aggregator.BranchNode.Output
	110, // 71: aggregator.RunNodeWithInputsResp.filter:type_name -> aggregator.FilterNode.Output
	112, // 72: aggregator.RunNodeWithInputsResp.loop:type_name -> aggregator.LoopNode.Output
	0,   // 73: aggregator.RunTriggerReq.trigger_type:type_name -> aggregator.TriggerType
	116, // 74: aggregator.RunTriggerReq.trigger_config:type_name -> aggregator.RunTriggerReq.TriggerConfigEntry
	74,  // 75: aggregator.RunTriggerResp.block_trigger:type_name -> aggregator.BlockTrigger.Output
	70,  // 76: aggregator.RunTriggerResp.fixed_time_trigger:type_name -> aggregator.FixedTimeTrigger.Output
	72,  // 77: aggregator.RunTriggerResp.cron_trigger:type_name -> aggregator.CronTrigger.Output
	78,  // 78: aggregator.RunTriggerResp.event_trigger:type_name -> aggregator.EventTrigger.Output
	81,  // 79: aggregator.RunTriggerResp.manual_trigger:type_name -> aggregator.ManualTrigger.Output
	15,  // 80: aggregator.SimulateTaskReq.trigger:type_name -> aggregator.TaskTrigger
	26,  // 81: aggregator.SimulateTaskReq.nodes:type_name -> aggregator.TaskNode
	25,  // 82: aggregator.SimulateTaskReq.edges:type_name -> aggregator.TaskEdge
	120, // 83: aggregator.SimulateTaskReq.input_variables:type_name -> aggregator.SimulateTaskReq.InputVariablesEntry
	76,  // 84: aggregator.EventTrigger.Query.topics:type_name -> aggregator.EventTrigger.Topics
	75,  // 85: aggregator.EventTrigger.Config.queries:type_name -> aggregator.EventTrigger.Query
	117, // 86: aggregator.EventTrigger.Output.evm_log:type_name -> aggregator.Evm.Log
	79,  // 87: aggregator.EventTrigger.Output.transfer_log:type_name -> aggregator.EventTrigger.TransferLogOutput
	85,  // 88: aggregator.ContractWriteNode.Config.method_calls:type_name -> aggregator.ContractWriteNode.MethodCall
	87,  // 89: aggregator.ContractWriteNode.Output.results:type_name -> aggregator.ContractWriteNode.MethodResult
	88,  // 90: aggregator.ContractWriteNode.MethodResult.transaction:type_name -> aggregator.ContractWriteNode.TransactionData
	89,  // 91: aggregator.ContractWriteNode.MethodResult.events:type_name -> aggregator.ContractWriteNode.EventData
	90,  // 92: aggregator.ContractWriteNode.MethodResult.error:type_name -> aggregator.ContractWriteNode.ErrorData
	91,  // 93: aggregator.ContractWriteNode.MethodResult.return_data:type_name -> aggregator.ContractWriteNode.ReturnData
	92,  // 94: aggregator.ContractWriteNode.EventData.decoded:type_name -> aggregator.ContractWriteNode.EventData.DecodedEntry
	93,  // 95: aggregator.ContractReadNode.Config.method_calls:type_name -> aggregator.ContractReadNode.MethodCall
	97,  // 96: aggregator.ContractReadNode.MethodResult.data:type_name -> aggregator.ContractReadNode.MethodResult.StructuredField
	95,  // 97: aggregator.ContractReadNode.Output.results:type_name -> aggregator.ContractReadNode.MethodResult
	100, // 98: aggregator.GraphQLQueryNode.Config.variables:type_name -> aggregator.GraphQLQueryNode.Config.VariablesEntry
	122, // 99: aggregator.GraphQLQueryNode.Output.data:type_name -> google.protobuf.Any
	103, // 100: aggregator.RestAPINode.Config.headers:type_name -> aggregator.RestAPINode.Config.HeadersEntry
	121, // 101: aggregator.RestAPINode.Output.data:type_name -> google.protobuf.Value
	2,   // 102: aggregator.CustomCodeNode.Config.lang:type_name -> aggregator.Lang
	121, // 103: aggregator.CustomCodeNode.Output.data:type_name -> google.protobuf.Value
	106, // 104: aggregator.BranchNode.Config.conditions:type_name -> aggregator.BranchNode.Condition
	122, // 105: aggregator.FilterNode.Output.data:type_name -> google.protobuf.Any
	74,  // 106: aggregator.Execution.Step.block_trigger:type_name -> aggregator.BlockTrigger.Output
	70,  // 107: aggregator.Execution.Step.fixed_time_trigger:type_name -> aggregator.FixedTimeTrigger.Output
	72,  // 108: aggregator.Execution.Step.cron_trigger:type_name -> aggregator.CronTrigger.Output
	78,  // 109: aggregator.Execution.Step.event_trigger:type_name -> aggregator.EventTrigger.Output
	81,  // 110: aggregator.Execution.Step.manual_trigger:type_name -> aggregator.ManualTrigger.Output
	83,  // 111: aggregator.Execution.Step.eth_transfer:type_name -> aggregator.ETHTransferNode.Output
	99,  // 112: aggregator.Execution.Step.graphql:type_name -> aggregator.GraphQLQueryNode.Output
	96,  // 113: aggregator.Execution.Step.contract_read:type_name -> aggregator.ContractReadNode.Output
	86,  // 114: aggregator.Execution.Step.contract_write:type_name -> aggregator.ContractWriteNode.Output
	105, // 115: aggregator.Execution.Step.custom_code:type_name -> aggregator.CustomCodeNode.Output
	102, // 116: aggregator.Execution.Step.rest_api:type_name -> aggregator.RestAPINode.Output
	108, // 117: aggregator.Execution.Step.branch:type_name -> aggregator.BranchNode.Output
	110, // 118: aggregator.Execution.Step.filter:type_name -> aggregator.FilterNode.Output
	112, // 119: aggregator.Execution.Step.loop:type_name -> aggregator.LoopNode.Output
	121, // 120: aggregator.RunNodeWithInputsReq.NodeConfigEntry.value:type_name -> google.protobuf.Value
	121, // 121: aggregator.RunNodeWithInputsReq.InputVariablesEntry.value:type_name -> google.protobuf.Value
	121, // 122: aggregator.RunTriggerReq.TriggerConfigEntry.value:type_name -> google.protobuf.Value
	121, // 123: aggregator.SimulateTaskReq.InputVariablesEntry.value:type_name -> google.protobuf.Value
	42,  // 124: aggregator.Aggregator.GetKey:input_type -> aggregator.GetKeyReq
	55,  // 125: aggregator.Aggregator.GetSignatureFormat:input_type -> aggregator.GetSignatureFormatReq
	31,  // 126: aggregator.Aggregator.GetNonce:input_type -> aggregator.NonceRequest
	44,  // 127: aggregator.Aggregator.GetWallet:input_type -> aggregator.GetWalletReq
	46,  // 128: aggregator.Aggregator.SetWallet:input_type -> aggregator.SetWalletReq
	33,  // 129: aggregator.Aggregator.ListWallets:input_type -> aggregator.ListWalletReq
	29,  // 130: aggregator.Aggregator.CreateTask:input_type -> aggregator.CreateTaskReq
	36,  // 131: aggregator.Aggregator.ListTasks:input_type -> aggregator.ListTasksReq
	9,   // 132: aggregator.Aggregator.GetTask:input_type -> aggregator.IdReq
	38,  // 133: aggregator.Aggregator.ListExecutions:input_type -> aggregator.ListExecutionsReq
	40,  // 134: aggregator.Aggregator.GetExecution:input_type -> aggregator.ExecutionReq
	40,  // 135: aggregator.Aggregator.GetExecutionStatus:input_type -> aggregator.ExecutionReq
	9,   // 136: aggregator.Aggregator.CancelTask:input_type -> aggregator.IdReq
	9,   // 137: aggregator.Aggregator.DeleteTask:input_type -> aggregator.IdReq
	47,  // 138: aggregator.Aggregator.TriggerTask:input_type -> aggregator.TriggerTaskReq
	49,  // 139: aggregator.Aggregator.CreateSecret:input_type -> aggregator.CreateOrUpdateSecretReq
	54,  // 140: aggregator.Aggregator.DeleteSecret:input_type -> aggregator.DeleteSecretReq
	50,  // 141: aggregator.Aggregator.ListSecrets:input_type -> aggregator.ListSecretsReq
	49,  // 142: aggregator.Aggregator.UpdateSecret:input_type -> aggregator.CreateOrUpdateSecretReq
	57,  // 143: aggregator.Aggregator.GetWorkflowCount:input_type -> aggregator.GetWorkflowCountReq
	59,  // 144: aggregator.Aggregator.GetExecutionCount:input_type -> aggregator.GetExecutionCountReq
	61,  // 145: aggregator.Aggregator.GetExecutionStats:input_type -> aggregator.GetExecutionStatsReq
	63,  // 146: aggregator.Aggregator.RunNodeWithInputs:input_type -> aggregator.RunNodeWithInputsReq
	65,  // 147: aggregator.Aggregator.RunTrigger:input_type -> aggregator.RunTriggerReq
	68,  // 148: aggregator.Aggregator.SimulateTask:input_type -> aggregator.SimulateTaskReq
	7,   // 149: aggregator.Aggregator.GetTokenMetadata:input_type -> aggregator.GetTokenMetadataReq
	43,  // 150: aggregator.Aggregator.GetKey:output_type -> aggregator.KeyResp
	56,  // 151: aggregator.Aggregator.GetSignatureFormat:output_type -> aggregator.GetSignatureFormatResp
	32,  // 152: aggregator.Aggregator.GetNonce:output_type -> aggregator.NonceResp
	45,  // 153: aggregator.Aggregator.GetWallet:output_type -> aggregator.GetWalletResp
	45,  // 154: aggregator.Aggregator.SetWallet:output_type -> aggregator.GetWalletResp
	35,  // 155: aggregator.Aggregator.ListWallets:output_type -> aggregator.ListWalletResp
	30,  // 156: aggregator.Aggregator.CreateTask:output_type -> aggregator.CreateTaskResp
	37,  // 157: aggregator.Aggregator.ListTasks:output_type -> aggregator.ListTasksResp
	28,  // 158: aggregator.Aggregator.GetTask:output_type -> aggregator.Task
	39,  // 159: aggregator.Aggregator.ListExecutions:output_type -> aggregator.ListExecutionsResp
	27,  // 160: aggregator.Aggregator.GetExecution:output_type -> aggregator.Execution
	41,  // 161: aggregator.Aggregator.GetExecutionStatus:output_type -> aggregator.ExecutionStatusResp
	123, // 162: aggregator.Aggregator.CancelTask:output_type -> google.protobuf.BoolValue
	123, // 163: aggregator.Aggregator.DeleteTask:output_type -> google.protobuf.BoolValue
	48,  // 164: aggregator.Aggregator.TriggerTask:output_type -> aggregator.TriggerTaskResp
	123, // 165: aggregator.Aggregator.CreateSecret:output_type -> google.protobuf.BoolValue
	123, // 166: aggregator.Aggregator.DeleteSecret:output_type -> google.protobuf.BoolValue
	53,  // 167: aggregator.Aggregator.ListSecrets:output_type -> aggregator.ListSecretsResp
	123, // 168: aggregator.Aggregator.UpdateSecret:output_type -> google.protobuf.BoolValue
	58,  // 169: aggregator.Aggregator.GetWorkflowCount:output_type -> aggregator.GetWorkflowCountResp
	60,  // 170: aggregator.Aggregator.GetExecutionCount:output_type -> aggregator.GetExecutionCountResp
	62,  // 171: aggregator.Aggregator.GetExecutionStats:output_type -> aggregator.GetExecutionStatsResp
	64,  // 172: aggregator.Aggregator.RunNodeWithInputs:output_type -> aggregator.RunNodeWithInputsResp
	66,  // 173: aggregator.Aggregator.RunTrigger:output_type -> aggregator.RunTriggerResp
	27,  // 174: aggregator.Aggregator.SimulateTask:output_type -> aggregator.Execution
	8,   // 175: aggregator.Aggregator.GetTokenMetadata:output_type -> aggregator.GetTokenMetadataResp
...
func file_avs_proto_init() {
	...
	file_avs_proto_msgTypes[72].OneofWrappers = []any{
