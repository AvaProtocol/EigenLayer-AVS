...
type BlockTrigger_Config struct {
	...
	// Chain to watch blocks on. Required: a task no longer provides a chain to inherit.
	ChainId       int64 `protobuf:"varint,2,opt,name=chain_id,json=chainId,proto3" json:"chain_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type EventTrigger_Config struct {
	...
	// Chain to watch events on. Required: a task no longer provides a chain to inherit.
...
type ETHTransferNode_Config struct {
	...
	Amount      string                 `protobuf:"bytes,2,opt,name=amount,proto3" json:"amount,omitempty"`
	// Chain to execute the transfer on. Required: a task no longer provides a chain to inherit.
	ChainId       int64 `protobuf:"varint,3,opt,name=chain_id,json=chainId,proto3" json:"chain_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type ContractWriteNode_Config struct {
	...
	// Chain to execute the write on. Required: a task no longer provides a chain to inherit.
...
type ContractReadNode_Config struct {
	...
	// Chain to read state from. Required: a task no longer provides a chain to inherit.
	ChainId       int64 `protobuf:"varint,4,opt,name=chain_id,json=chainId,proto3" json:"chain_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
