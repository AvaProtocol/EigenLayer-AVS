...
var file_protobuf_avs_proto_rawDesc = []byte{
	...
	0x73, 0x73, 0x69, 0x6f, 0x6e, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x10, 0x02, 0x32, 0x99,
	...
	,
...
var file_protobuf_avs_proto_depIdxs = []int32{
	...
	4,  // 29: aggregator.Aggregator.Ping:input_type -> aggregator.Checkin
	6,  // 30: aggregator.Aggregator.SyncTasks:input_type -> aggregator.SyncTasksReq
	27, // 31: aggregator.Aggregator.UpdateChecks:input_type -> aggregator.UpdateChecksReq
	26, // 32: aggregator.Aggregator.GetKey:output_type -> aggregator.KeyResp
	20, // 33: aggregator.Aggregator.GetNonce:output_type -> aggregator.NonceResp
	22, // 34: aggregator.Aggregator.GetSmartAccountAddress:output_type -> aggregator.AddressResp
	18, // 35: aggregator.Aggregator.CreateTask:output_type -> aggregator.CreateTaskResp
	24, // 36: aggregator.Aggregator.ListTasks:output_type -> aggregator.ListTasksResp
	16, // 37: aggregator.Aggregator.GetTask:output_type -> aggregator.Task
	32, // 38: aggregator.Aggregator.CancelTask:output_type -> google.protobuf.BoolValue
	5,  // 39: aggregator.Aggregator.Ping:output_type -> aggregator.CheckinResp
	7,  // 40: aggregator.Aggregator.SyncTasks:output_type -> aggregator.SyncTasksResp
	28, // 41: aggregator.Aggregator.UpdateChecks:output_type -> aggregator.UpdateChecksResp
