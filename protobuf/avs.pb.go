...
var file_protobuf_avs_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x73, 0x74, 0x61, 0x72, 0x74,
	...
	0x52, 0x07, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x73, 0x22, 0x58, 0x0a, 0x0c, 0x4c, 0x69, 0x73,
	...
	0x73, 0x6f, 0x72, 0x22, 0x4f, 0x0a, 0x0d, 0x4c, 0x69, 0x73, 0x74, 0x54, 0x61, 0x73, 0x6b, 0x73,
	...
	0x72, 0x73, 0x6f, 0x72, 0x22, 0x3b, 0x0a, 0x11, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x78, 0x65, 0x63,
	...
	0x72, 0x22, 0x63, 0x0a, 0x12, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69,
	0x6f, 0x6e, 0x73, 0x52, 0x65, 0x73, 0x70, 0x12, 0x35, 0x0a, 0x0a, 0x65, 0x78, 0x65, 0x63, 0x75,
	...
	0x6f, 0x6e, 0x52, 0x0a, 0x65, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x16,
	0x0a, 0x06, 0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06,
	0x63, 0x75, 0x72, 0x73, 0x6f, 0x72, 0x22, 0x5e, 0x0a, 0x09, 0x47, 0x65, 0x74, 0x4b, 0x65, 0x79,
	...
	0x6b, 0x65, 0x79, 0x22, 0x66, 0x0a, 0x0b, 0x54, 0x72, 0x69, 0x67, 0x67, 0x65, 0x72, 0x4d, 0x61,
	0x72, 0x6b, 0x12, 0x21, 0x0a, 0x0c, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x5f, 0x6e, 0x75, 0x6d, 0x62,
	...
	0x65, 0x78, 0x12, 0x17, 0x0a, 0x07, 0x74, 0x78, 0x5f, 0x68, 0x61, 0x73, 0x68, 0x18, 0x03, 0x20,
	0x01, 0x28, 0x09, 0x52, 0x06, 0x74, 0x78, 0x48, 0x61, 0x73, 0x68, 0x22, 0x4e, 0x0a, 0x0f, 0x43,
	...
	0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x2a, 0xc8, 0x01, 0x0a, 0x05, 0x45, 0x72, 0x72, 0x6f, 0x72,
	...
	0x69, 0x70, 0x74, 0x10, 0x00, 0x32, 0xa6, 0x05, 0x0a, 0x0a, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67,
	...
	0x65, 0x67, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x54, 0x61, 0x73, 0x6b, 0x22, 0x00, 0x12, 0x51, 0x0a,
	0x0e, 0x4c, 0x69, 0x73, 0x74, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x12,
	0x1d, 0x2e, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x4c, 0x69, 0x73,
	0x74, 0x45, 0x78, 0x65, 0x63, 0x75, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x52, 0x65, 0x71, 0x1a, 0x1e,
	0x2e, 0x61, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x6f, 0x72, 0x2e, 0x4c, 0x69, 0x73, 0x74,
...
var file_protobuf_avs_proto_msgTypes = make([]protoimpl.MessageInfo, 39)
...
var file_protobuf_avs_proto_depIdxs = []int32{
	...
	34, // 35: aggregator.Aggregator.GetKey:input_type -> aggregator.GetKeyReq
	25, // 36: aggregator.Aggregator.GetNonce:input_type -> aggregator.NonceRequest
	37, // 37: aggregator.Aggregator.CreateWallet:input_type -> aggregator.CreateWalletReq
	...
	32, // 42: aggregator.Aggregator.ListExecutions:input_type -> aggregator.ListExecutionsReq
	...
	35, // 45: aggregator.Aggregator.GetKey:output_type -> aggregator.KeyResp
	26, // 46: aggregator.Aggregator.GetNonce:output_type -> aggregator.NonceResp
	38, // 47: aggregator.Aggregator.CreateWallet:output_type -> aggregator.CreateWalletResp
	...
	33, // 52: aggregator.Aggregator.ListExecutions:output_type -> aggregator.ListExecutionsResp
	42, // 53: aggregator.Aggregator.CancelTask:output_type -> google.protobuf.BoolValue
	42, // 54: aggregator.Aggregator.DeleteTask:output_type -> google.protobuf.BoolValue
