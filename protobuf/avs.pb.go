...
func (x *BranchNode_Condition) GetLang() Lang {
	if x != nil {
		return x.Lang
	}
	return Lang_LANG_UNSPECIFIED
...
type FilterNode_Config struct {
	...
	// Language of the expression field - for validation (default: JavaScript for backward compatibility)
	Lang          Lang `protobuf:"varint,3,opt,name=lang,proto3,enum=aggregator.Lang" json:"lang,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *FilterNode_Config) GetLang() Lang {
	if x != nil {
		return x.Lang
	}
	return Lang_LANG_UNSPECIFIED
...
const file_avs_proto_rawDesc = "" +
	...
	"\n" +
	"BranchNode\x125\n" +
	"\x06config\x18\x01 \x01(\v2\x1d.aggregator.BranchNode.ConfigR\x06config\x1au\n" +
	"\tCondition\x12\x0e\n" +
	...
	"expression\x12$\n" +
	"\x04lang\x18\x04 \x01(\x0e2\x10.aggregator.LangR\x04lang\x1aJ\n" +
	"\x06Config\x12@\n" +
	"\n" +
	"conditions\x18\x01 \x03(\v2 .aggregator.BranchNode.ConditionR\n" +
	"conditions\x1a4\n" +
	"\x06Output\x12*\n" +
	"\x04data\x18\x01 \x01(\v2\x16.google.protobuf.ValueR\x04data\"\xf1\x01\n" +
	"\n" +
	"FilterNode\x125\n" +
	"\x06config\x18\x01 \x01(\v2\x1d.aggregator.FilterNode.ConfigR\x06config\x1av\n" +
	"\x06Config\x12\x1e\n" +
	"\n" +
	"expression\x18\x01 \x01(\tR\n" +
	"expression\x12&\n" +
	"\x0finput_node_name\x18\x02 \x01(\tR\rinputNodeName\x12$\n" +
	"\x04lang\x18\x03 \x01(\x0e2\x10.aggregator.LangR\x04lang\x1a4\n" +
	"\x06Output\x12*\n" +
...
var file_avs_proto_msgTypes = make([]protoimpl.MessageInfo, 128)
var file_avs_proto_goTypes = []any{
	...
	(*BranchNode)(nil),                                    // 23: aggregator.BranchNode
	(*FilterNode)(nil),                                    // 24: aggregator.FilterNode
	(*LoopNode)(nil),                                      // 25: aggregator.LoopNode
	(*TaskEdge)(nil),                                      // 26: aggregator.TaskEdge
	(*TaskNode)(nil),                                      // 27: aggregator.TaskNode
	(*Execution)(nil),                                     // 28: aggregator.Execution
	(*Task)(nil),                                          // 29: aggregator.Task
	(*CreateTaskReq)(nil),                                 // 30: aggregator.CreateTaskReq
	(*CreateTaskResp)(nil),                                // 31: aggregator.CreateTaskResp
	(*NonceRequest)(nil),                                  // 32: aggregator.NonceRequest
	(*NonceResp)(nil),                                     // 33: aggregator.NonceResp
	(*ListWalletReq)(nil),                                 // 34: aggregator.ListWalletReq
	(*SmartWallet)(nil),                                   // 35: aggregator.SmartWallet
	(*ListWalletResp)(nil),                                // 36: aggregator.ListWalletResp
	(*ListTasksReq)(nil),                                  // 37: aggregator.ListTasksReq
	(*ListTasksResp)(nil),                                 // 38: aggregator.ListTasksResp
	(*ListExecutionsReq)(nil),                             // 39: aggregator.ListExecutionsReq
	(*ListExecutionsResp)(nil),                            // 40: aggregator.ListExecutionsResp
	(*ExecutionReq)(nil),                                  // 41: aggregator.ExecutionReq
	(*ExecutionStatusResp)(nil),                           // 42: aggregator.ExecutionStatusResp
	(*GetKeyReq)(nil),                                     // 43: aggregator.GetKeyReq
	(*KeyResp)(nil),                                       // 44: aggregator.KeyResp
	(*GetWalletReq)(nil),                                  // 45: aggregator.GetWalletReq
	(*GetWalletResp)(nil),                                 // 46: aggregator.GetWalletResp
	(*SetWalletReq)(nil),                                  // 47: aggregator.SetWalletReq
	(*WithdrawFundsReq)(nil),                              // 48: aggregator.WithdrawFundsReq
	(*WithdrawFundsResp)(nil),                             // 49: aggregator.WithdrawFundsResp
	(*TriggerTaskReq)(nil),                                // 50: aggregator.TriggerTaskReq
	(*TriggerTaskResp)(nil),                               // 51: aggregator.TriggerTaskResp
	(*CreateOrUpdateSecretReq)(nil),                       // 52: aggregator.CreateOrUpdateSecretReq
	(*ListSecretsReq)(nil),                                // 53: aggregator.ListSecretsReq
	(*PageInfo)(nil),                                      // 54: aggregator.PageInfo
	(*Secret)(nil),                                        // 55: aggregator.Secret
	(*ListSecretsResp)(nil),                               // 56: aggregator.ListSecretsResp
	(*DeleteSecretReq)(nil),                               // 57: aggregator.DeleteSecretReq
	(*DeleteSecretResp)(nil),                              // 58: aggregator.DeleteSecretResp
	(*GetSignatureFormatReq)(nil),                         // 59: aggregator.GetSignatureFormatReq
	(*GetSignatureFormatResp)(nil),                        // 60: aggregator.GetSignatureFormatResp
	(*CreateSecretResp)(nil),                              // 61: aggregator.CreateSecretResp
	(*UpdateSecretResp)(nil),                              // 62: aggregator.UpdateSecretResp
	(*DeleteTaskResp)(nil),                                // 63: aggregator.DeleteTaskResp
	(*CancelTaskResp)(nil),                                // 64: aggregator.CancelTaskResp
	(*GetWorkflowCountReq)(nil),                           // 65: aggregator.GetWorkflowCountReq
	(*GetWorkflowCountResp)(nil),                          // 66: aggregator.GetWorkflowCountResp
	(*GetExecutionCountReq)(nil),                          // 67: aggregator.GetExecutionCountReq
	(*GetExecutionCountResp)(nil),                         // 68: aggregator.GetExecutionCountResp
	(*GetExecutionStatsReq)(nil),                          // 69: aggregator.GetExecutionStatsReq
	(*GetExecutionStatsResp)(nil),                         // 70: aggregator.GetExecutionStatsResp
	(*RunNodeWithInputsReq)(nil),                          // 71: aggregator.RunNodeWithInputsReq
	(*RunNodeWithInputsResp)(nil),                         // 72: aggregator.RunNodeWithInputsResp
	(*RunTriggerReq)(nil),                                 // 73: aggregator.RunTriggerReq
	(*RunTriggerResp)(nil),                                // 74: aggregator.RunTriggerResp
	(*SimulateTaskReq)(nil),                               // 75: aggregator.SimulateTaskReq
	(*EstimateFeesReq)(nil),                               // 76: aggregator.EstimateFeesReq
	(*FeeAmount)(nil),                                     // 77: aggregator.FeeAmount
	(*GasFeeBreakdown)(nil),                               // 78: aggregator.GasFeeBreakdown
	(*GasOperationFee)(nil),                               // 79: aggregator.GasOperationFee
	(*SmartWalletCreationFee)(nil),                        // 80: aggregator.SmartWalletCreationFee
	(*AutomationFee)(nil),                                 // 81: aggregator.AutomationFee
	(*FeeDiscount)(nil),                                   // 82: aggregator.FeeDiscount
	(*EstimateFeesResp)(nil),                              // 83: aggregator.EstimateFeesResp
	(*EventCondition)(nil),                                // 84: aggregator.EventCondition
	(*FixedTimeTrigger_Config)(nil),                       // 85: aggregator.FixedTimeTrigger.Config
	(*FixedTimeTrigger_Output)(nil),                       // 86: aggregator.FixedTimeTrigger.Output
	(*CronTrigger_Config)(nil),                            // 87: aggregator.CronTrigger.Config
	(*CronTrigger_Output)(nil),                            // 88: aggregator.CronTrigger.Output
	(*BlockTrigger_Config)(nil),                           // 89: aggregator.BlockTrigger.Config
	(*BlockTrigger_Output)(nil),                           // 90: aggregator.BlockTrigger.Output
	(*EventTrigger_Query)(nil),                            // 91: aggregator.EventTrigger.Query
	(*EventTrigger_MethodCall)(nil),                       // 92: aggregator.EventTrigger.MethodCall
	(*EventTrigger_Topics)(nil),                           // 93: aggregator.EventTrigger.Topics
	...
	(*BranchNode_Condition)(nil),                          // 119: aggregator.BranchNode.Condition
	(*BranchNode_Config)(nil),                             // 120: aggregator.BranchNode.Config
	(*BranchNode_Output)(nil),                             // 121: aggregator.BranchNode.Output
	(*FilterNode_Config)(nil),                             // 122: aggregator.FilterNode.Config
	(*FilterNode_Output)(nil),                             // 123: aggregator.FilterNode.Output
	(*LoopNode_Config)(nil),                               // 124: aggregator.LoopNode.Config
	(*LoopNode_Output)(nil),                               // 125: aggregator.LoopNode.Output
	(*Execution_Step)(nil),                                // 126: aggregator.Execution.Step
	nil,                                                   // 127: aggregator.Task.InputVariablesEntry
	nil,                                                   // 128: aggregator.CreateTaskReq.InputVariablesEntry
	nil,                                                   // 129: aggregator.RunNodeWithInputsReq.NodeConfigEntry
	nil,                                                   // 130: aggregator.RunNodeWithInputsReq.InputVariablesEntry
	nil,                                                   // 131: aggregator.RunTriggerReq.TriggerConfigEntry
	nil,                                                   // 132: aggregator.RunTriggerReq.TriggerInputEntry
	nil,                                                   // 133: aggregator.SimulateTaskReq.InputVariablesEntry
	nil,                                                   // 134: aggregator.EstimateFeesReq.InputVariablesEntry
...
var file_avs_proto_depIdxs = []int32{
	...
	85,  // 1: aggregator.FixedTimeTrigger.config:type_name -> aggregator.FixedTimeTrigger.Config
	87,  // 2: aggregator.CronTrigger.config:type_name -> aggregator.CronTrigger.Config
	89,  // 3: aggregator.BlockTrigger.config:type_name -> aggregator.BlockTrigger.Config
	...
	120, // 18: aggregator.BranchNode.config:type_name -> aggregator.BranchNode.Config
	122, // 19: aggregator.FilterNode.config:type_name -> aggregator.FilterNode.Config
	17,  // 20: aggregator.LoopNode.eth_transfer:type_name -> aggregator.ETHTransferNode
	18,  // 21: aggregator.LoopNode.contract_write:type_name -> aggregator.ContractWriteNode
	19,  // 22: aggregator.LoopNode.contract_read:type_name -> aggregator.ContractReadNode
	20,  // 23: aggregator.LoopNode.graphql_data_query:type_name -> aggregator.GraphQLQueryNode
	21,  // 24: aggregator.LoopNode.rest_api:type_name -> aggregator.RestAPINode
	22,  // 25: aggregator.LoopNode.custom_code:type_name -> aggregator.CustomCodeNode
	124, // 26: aggregator.LoopNode.config:type_name -> aggregator.LoopNode.Config
	1,   // 27: aggregator.TaskNode.type:type_name -> aggregator.NodeType
	17,  // 28: aggregator.TaskNode.eth_transfer:type_name -> aggregator.ETHTransferNode
	18,  // 29: aggregator.TaskNode.contract_write:type_name -> aggregator.ContractWriteNode
	19,  // 30: aggregator.TaskNode.contract_read:type_name -> aggregator.ContractReadNode
	20,  // 31: aggregator.TaskNode.graphql_query:type_name -> aggregator.GraphQLQueryNode
	21,  // 32: aggregator.TaskNode.rest_api:type_name -> aggregator.RestAPINode
	23,  // 33: aggregator.TaskNode.branch:type_name -> aggregator.BranchNode
	24,  // 34: aggregator.TaskNode.filter:type_name -> aggregator.FilterNode
	25,  // 35: aggregator.TaskNode.loop:type_name -> aggregator.LoopNode
	22,  // 36: aggregator.TaskNode.custom_code:type_name -> aggregator.CustomCodeNode
	6,   // 37: aggregator.Execution.status:type_name -> aggregator.ExecutionStatus
	126, // 38: aggregator.Execution.steps:type_name -> aggregator.Execution.Step
	5,   // 39: aggregator.Task.status:type_name -> aggregator.TaskStatus
	...
	127, // 43: aggregator.Task.input_variables:type_name -> aggregator.Task.InputVariablesEntry
	...
	128, // 47: aggregator.CreateTaskReq.input_variables:type_name -> aggregator.CreateTaskReq.InputVariablesEntry
	...
	90,  // 55: aggregator.TriggerTaskReq.block_trigger:type_name -> aggregator.BlockTrigger.Output
	86,  // 56: aggregator.TriggerTaskReq.fixed_time_trigger:type_name -> aggregator.FixedTimeTrigger.Output
	88,  // 57: aggregator.TriggerTaskReq.cron_trigger:type_name -> aggregator.CronTrigger.Output
	95,  // 58: aggregator.TriggerTaskReq.event_trigger:type_name -> aggregator.EventTrigger.Output
	97,  // 59: aggregator.TriggerTaskReq.manual_trigger:type_name -> aggregator.ManualTrigger.Output
	6,   // 60: aggregator.TriggerTaskResp.status:type_name -> aggregator.ExecutionStatus
	126, // 61: aggregator.TriggerTaskResp.steps:type_name -> aggregator.Execution.Step
	...
	129, // 65: aggregator.RunNodeWithInputsReq.node_config:type_name -> aggregator.RunNodeWithInputsReq.NodeConfigEntry
	130, // 66: aggregator.RunNodeWithInputsReq.input_variables:type_name -> aggregator.RunNodeWithInputsReq.InputVariablesEntry
	135, // 67: aggregator.RunNodeWithInputsResp.metadata:type_name -> google.protobuf.Value
	135, // 68: aggregator.RunNodeWithInputsResp.execution_context:type_name -> google.protobuf.Value
	4,   // 69: aggregator.RunNodeWithInputsResp.error_code:type_name -> aggregator.ErrorCode
	101, // 70: aggregator.RunNodeWithInputsResp.eth_transfer:type_name -> aggregator.ETHTransferNode.Output
	112, // 71: aggregator.RunNodeWithInputsResp.graphql:type_name -> aggregator.GraphQLQueryNode.Output
	109, // 72: aggregator.RunNodeWithInputsResp.contract_read:type_name -> aggregator.ContractReadNode.Output
	104, // 73: aggregator.RunNodeWithInputsResp.contract_write:type_name -> aggregator.ContractWriteNode.Output
	118, // 74: aggregator.RunNodeWithInputsResp.custom_code:type_name -> aggregator.CustomCodeNode.Output
	115, // 75: aggregator.RunNodeWithInputsResp.rest_api:type_name -> aggregator.RestAPINode.Output
	121, // 76: aggregator.RunNodeWithInputsResp.branch:type_name -> aggregator.BranchNode.Output
	123, // 77: aggregator.RunNodeWithInputsResp.filter:type_name -> aggregator.FilterNode.Output
	125, // 78: aggregator.RunNodeWithInputsResp.loop:type_name -> aggregator.LoopNode.Output
	0,   // 79: aggregator.RunTriggerReq.trigger_type:type_name -> aggregator.TriggerType
	131, // 80: aggregator.RunTriggerReq.trigger_config:type_name -> aggregator.RunTriggerReq.TriggerConfigEntry
	132, // 81: aggregator.RunTriggerReq.trigger_input:type_name -> aggregator.RunTriggerReq.TriggerInputEntry
	135, // 82: aggregator.RunTriggerResp.metadata:type_name -> google.protobuf.Value
	135, // 83: aggregator.RunTriggerResp.execution_context:type_name -> google.protobuf.Value
	4,   // 84: aggregator.RunTriggerResp.error_code:type_name -> aggregator.ErrorCode
	90,  // 85: aggregator.RunTriggerResp.block_trigger:type_name -> aggregator.BlockTrigger.Output
	86,  // 86: aggregator.RunTriggerResp.fixed_time_trigger:type_name -> aggregator.FixedTimeTrigger.Output
	88,  // 87: aggregator.RunTriggerResp.cron_trigger:type_name -> aggregator.CronTrigger.Output
	95,  // 88: aggregator.RunTriggerResp.event_trigger:type_name -> aggregator.EventTrigger.Output
	97,  // 89: aggregator.RunTriggerResp.manual_trigger:type_name -> aggregator.ManualTrigger.Output
	...
	133, // 93: aggregator.SimulateTaskReq.input_variables:type_name -> aggregator.SimulateTaskReq.InputVariablesEntry
	16,  // 94: aggregator.EstimateFeesReq.trigger:type_name -> aggregator.TaskTrigger
	27,  // 95: aggregator.EstimateFeesReq.nodes:type_name -> aggregator.TaskNode
	26,  // 96: aggregator.EstimateFeesReq.edges:type_name -> aggregator.TaskEdge
	134, // 97: aggregator.EstimateFeesReq.input_variables:type_name -> aggregator.EstimateFeesReq.InputVariablesEntry
	77,  // 98: aggregator.GasFeeBreakdown.total_gas_fees:type_name -> aggregator.FeeAmount
	79,  // 99: aggregator.GasFeeBreakdown.operations:type_name -> aggregator.GasOperationFee
	77,  // 100: aggregator.GasOperationFee.fee:type_name -> aggregator.FeeAmount
	77,  // 101: aggregator.SmartWalletCreationFee.creation_fee:type_name -> aggregator.FeeAmount
	77,  // 102: aggregator.SmartWalletCreationFee.initial_funding:type_name -> aggregator.FeeAmount
	77,  // 103: aggregator.AutomationFee.base_fee:type_name -> aggregator.FeeAmount
	77,  // 104: aggregator.AutomationFee.monitoring_fee:type_name -> aggregator.FeeAmount
	77,  // 105: aggregator.AutomationFee.execution_fee:type_name -> aggregator.FeeAmount
	77,  // 106: aggregator.FeeDiscount.discount_amount:type_name -> aggregator.FeeAmount
	4,   // 107: aggregator.EstimateFeesResp.error_code:type_name -> aggregator.ErrorCode
	78,  // 108: aggregator.EstimateFeesResp.gas_fees:type_name -> aggregator.GasFeeBreakdown
	81,  // 109: aggregator.EstimateFeesResp.automation_fees:type_name -> aggregator.AutomationFee
	80,  // 110: aggregator.EstimateFeesResp.creation_fees:type_name -> aggregator.SmartWalletCreationFee
	77,  // 111: aggregator.EstimateFeesResp.total_fees:type_name -> aggregator.FeeAmount
	82,  // 112: aggregator.EstimateFeesResp.discounts:type_name -> aggregator.FeeDiscount
	77,  // 113: aggregator.EstimateFeesResp.total_discounts:type_name -> aggregator.FeeAmount
	77,  // 114: aggregator.EstimateFeesResp.final_total:type_name -> aggregator.FeeAmount
	135, // 115: aggregator.FixedTimeTrigger.Output.data:type_name -> google.protobuf.Value
	135, // 116: aggregator.CronTrigger.Output.data:type_name -> google.protobuf.Value
	135, // 117: aggregator.BlockTrigger.Output.data:type_name -> google.protobuf.Value
	93,  // 118: aggregator.EventTrigger.Query.topics:type_name -> aggregator.EventTrigger.Topics
	135, // 119: aggregator.EventTrigger.Query.contract_abi:type_name -> google.protobuf.Value
	84,  // 120: aggregator.EventTrigger.Query.conditions:type_name -> aggregator.EventCondition
	92,  // 121: aggregator.EventTrigger.Query.method_calls:type_name -> aggregator.EventTrigger.MethodCall
	91,  // 122: aggregator.EventTrigger.Config.queries:type_name -> aggregator.EventTrigger.Query
	135, // 123: aggregator.EventTrigger.Output.data:type_name -> google.protobuf.Value
	135, // 124: aggregator.ManualTrigger.Config.data:type_name -> google.protobuf.Value
	98,  // 125: aggregator.ManualTrigger.Config.headers:type_name -> aggregator.ManualTrigger.Config.HeadersEntry
	99,  // 126: aggregator.ManualTrigger.Config.pathParams:type_name -> aggregator.ManualTrigger.Config.PathParamsEntry
	3,   // 127: aggregator.ManualTrigger.Config.lang:type_name -> aggregator.Lang
	135, // 128: aggregator.ManualTrigger.Output.data:type_name -> google.protobuf.Value
	135, // 129: aggregator.ETHTransferNode.Output.data:type_name -> google.protobuf.Value
	135, // 130: aggregator.ContractWriteNode.Config.contract_abi:type_name -> google.protobuf.Value
	103, // 131: aggregator.ContractWriteNode.Config.method_calls:type_name -> aggregator.ContractWriteNode.MethodCall
	135, // 132: aggregator.ContractWriteNode.Output.data:type_name -> google.protobuf.Value
	135, // 133: aggregator.ContractWriteNode.MethodResult.method_abi:type_name -> google.protobuf.Value
	135, // 134: aggregator.ContractWriteNode.MethodResult.receipt:type_name -> google.protobuf.Value
	135, // 135: aggregator.ContractWriteNode.MethodResult.value:type_name -> google.protobuf.Value
	135, // 136: aggregator.ContractReadNode.Config.contract_abi:type_name -> google.protobuf.Value
	106, // 137: aggregator.ContractReadNode.Config.method_calls:type_name -> aggregator.ContractReadNode.MethodCall
	110, // 138: aggregator.ContractReadNode.MethodResult.data:type_name -> aggregator.ContractReadNode.MethodResult.StructuredField
	135, // 139: aggregator.ContractReadNode.Output.data:type_name -> google.protobuf.Value
	113, // 140: aggregator.GraphQLQueryNode.Config.variables:type_name -> aggregator.GraphQLQueryNode.Config.VariablesEntry
	135, // 141: aggregator.GraphQLQueryNode.Output.data:type_name -> google.protobuf.Value
	116, // 142: aggregator.RestAPINode.Config.headers:type_name -> aggregator.RestAPINode.Config.HeadersEntry
	135, // 143: aggregator.RestAPINode.Output.data:type_name -> google.protobuf.Value
	3,   // 144: aggregator.CustomCodeNode.Config.lang:type_name -> aggregator.Lang
	135, // 145: aggregator.CustomCodeNode.Output.data:type_name -> google.protobuf.Value
	3,   // 146: aggregator.BranchNode.Condition.lang:type_name -> aggregator.Lang
	119, // 147: aggregator.BranchNode.Config.conditions:type_name -> aggregator.BranchNode.Condition
	135, // 148: aggregator.BranchNode.Output.data:type_name -> google.protobuf.Value
	3,   // 149: aggregator.FilterNode.Config.lang:type_name -> aggregator.Lang
	135, // 150: aggregator.FilterNode.Output.data:type_name -> google.protobuf.Value
	2,   // 151: aggregator.LoopNode.Config.execution_mode:type_name -> aggregator.ExecutionMode
	135, // 152: aggregator.LoopNode.Output.data:type_name -> google.protobuf.Value
	4,   // 153: aggregator.Execution.Step.error_code:type_name -> aggregator.ErrorCode
	135, // 154: aggregator.Execution.Step.config:type_name -> google.protobuf.Value
	135, // 155: aggregator.Execution.Step.metadata:type_name -> google.protobuf.Value
	135, // 156: aggregator.Execution.Step.execution_context:type_name -> google.protobuf.Value
	90,  // 157: aggregator.Execution.Step.block_trigger:type_name -> aggregator.BlockTrigger.Output
	86,  // 158: aggregator.Execution.Step.fixed_time_trigger:type_name -> aggregator.FixedTimeTrigger.Output
	88,  // 159: aggregator.Execution.Step.cron_trigger:type_name -> aggregator.CronTrigger.Output
	95,  // 160: aggregator.Execution.Step.event_trigger:type_name -> aggregator.EventTrigger.Output
	97,  // 161: aggregator.Execution.Step.manual_trigger:type_name -> aggregator.ManualTrigger.Output
	101, // 162: aggregator.Execution.Step.eth_transfer:type_name -> aggregator.ETHTransferNode.Output
	112, // 163: aggregator.Execution.Step.graphql:type_name -> aggregator.GraphQLQueryNode.Output
	109, // 164: aggregator.Execution.Step.contract_read:type_name -> aggregator.ContractReadNode.Output
	104, // 165: aggregator.Execution.Step.contract_write:type_name -> aggregator.ContractWriteNode.Output
	118, // 166: aggregator.Execution.Step.custom_code:type_name -> aggregator.CustomCodeNode.Output
	115, // 167: aggregator.Execution.Step.rest_api:type_name -> aggregator.RestAPINode.Output
	121, // 168: aggregator.Execution.Step.branch:type_name -> aggregator.BranchNode.Output
	123, // 169: aggregator.Execution.Step.filter:type_name -> aggregator.FilterNode.Output
	125, // 170: aggregator.Execution.Step.loop:type_name -> aggregator.LoopNode.Output
	135, // 171: aggregator.Task.InputVariablesEntry.value:type_name -> google.protobuf.Value
	135, // 172: aggregator.CreateTaskReq.InputVariablesEntry.value:type_name -> google.protobuf.Value
	135, // 173: aggregator.RunNodeWithInputsReq.NodeConfigEntry.value:type_name -> google.protobuf.Value
	135, // 174: aggregator.RunNodeWithInputsReq.InputVariablesEntry.value:type_name -> google.protobuf.Value
	135, // 175: aggregator.RunTriggerReq.TriggerConfigEntry.value:type_name -> google.protobuf.Value
	135, // 176: aggregator.RunTriggerReq.TriggerInputEntry.value:type_name -> google.protobuf.Value
	135, // 177: aggregator.SimulateTaskReq.InputVariablesEntry.value:type_name -> google.protobuf.Value
	135, // 178: aggregator.EstimateFeesReq.InputVariablesEntry.value:type_name -> google.protobuf.Value
	43,  // 179: aggregator.Aggregator.GetKey:input_type -> aggregator.GetKeyReq
	59,  // 180: aggregator.Aggregator.GetSignatureFormat:input_type -> aggregator.GetSignatureFormatReq
	32,  // 181: aggregator.Aggregator.GetNonce:input_type -> aggregator.NonceRequest
	45,  // 182: aggregator.Aggregator.GetWallet:input_type -> aggregator.GetWalletReq
	47,  // 183: aggregator.Aggregator.SetWallet:input_type -> aggregator.SetWalletReq
	34,  // 184: aggregator.Aggregator.ListWallets:input_type -> aggregator.ListWalletReq
	48,  // 185: aggregator.Aggregator.WithdrawFunds:input_type -> aggregator.WithdrawFundsReq
	30,  // 186: aggregator.Aggregator.CreateTask:input_type -> aggregator.CreateTaskReq
	37,  // 187: aggregator.Aggregator.ListTasks:input_type -> aggregator.ListTasksReq
	10,  // 188: aggregator.Aggregator.GetTask:input_type -> aggregator.IdReq
	39,  // 189: aggregator.Aggregator.ListExecutions:input_type -> aggregator.ListExecutionsReq
	41,  // 190: aggregator.Aggregator.GetExecution:input_type -> aggregator.ExecutionReq
	41,  // 191: aggregator.Aggregator.GetExecutionStatus:input_type -> aggregator.ExecutionReq
	10,  // 192: aggregator.Aggregator.CancelTask:input_type -> aggregator.IdReq
	10,  // 193: aggregator.Aggregator.DeleteTask:input_type -> aggregator.IdReq
	50,  // 194: aggregator.Aggregator.TriggerTask:input_type -> aggregator.TriggerTaskReq
	52,  // 195: aggregator.Aggregator.CreateSecret:input_type -> aggregator.CreateOrUpdateSecretReq
	57,  // 196: aggregator.Aggregator.DeleteSecret:input_type -> aggregator.DeleteSecretReq
	53,  // 197: aggregator.Aggregator.ListSecrets:input_type -> aggregator.ListSecretsReq
	52,  // 198: aggregator.Aggregator.UpdateSecret:input_type -> aggregator.CreateOrUpdateSecretReq
	65,  // 199: aggregator.Aggregator.GetWorkflowCount:input_type -> aggregator.GetWorkflowCountReq
	67,  // 200: aggregator.Aggregator.GetExecutionCount:input_type -> aggregator.GetExecutionCountReq
	69,  // 201: aggregator.Aggregator.GetExecutionStats:input_type -> aggregator.GetExecutionStatsReq
	71,  // 202: aggregator.Aggregator.RunNodeWithInputs:input_type -> aggregator.RunNodeWithInputsReq
	73,  // 203: aggregator.Aggregator.RunTrigger:input_type -> aggregator.RunTriggerReq
	75,  // 204: aggregator.Aggregator.SimulateTask:input_type -> aggregator.SimulateTaskReq
	8,   // 205: aggregator.Aggregator.GetTokenMetadata:input_type -> aggregator.GetTokenMetadataReq
	76,  // 206: aggregator.Aggregator.EstimateFees:input_type -> aggregator.EstimateFeesReq
	44,  // 207: aggregator.Aggregator.GetKey:output_type -> aggregator.KeyResp
	60,  // 208: aggregator.Aggregator.GetSignatureFormat:output_type -> aggregator.GetSignatureFormatResp
	33,  // 209: aggregator.Aggregator.GetNonce:output_type -> aggregator.NonceResp
	46,  // 210: aggregator.Aggregator.GetWallet:output_type -> aggregator.GetWalletResp
	46,  // 211: aggregator.Aggregator.SetWallet:output_type -> aggregator.GetWalletResp
	36,  // 212: aggregator.Aggregator.ListWallets:output_type -> aggregator.ListWalletResp
	49,  // 213: aggregator.Aggregator.WithdrawFunds:output_type -> aggregator.WithdrawFundsResp
	31,  // 214: aggregator.Aggregator.CreateTask:output_type -> aggregator.CreateTaskResp
	38,  // 215: aggregator.Aggregator.ListTasks:output_type -> aggregator.ListTasksResp
	29,  // 216: aggregator.Aggregator.GetTask:output_type -> aggregator.Task
	40,  // 217: aggregator.Aggregator.ListExecutions:output_type -> aggregator.ListExecutionsResp
	28,  // 218: aggregator.Aggregator.GetExecution:output_type -> aggregator.Execution
	42,  // 219: aggregator.Aggregator.GetExecutionStatus:output_type -> aggregator.ExecutionStatusResp
	64,  // 220: aggregator.Aggregator.CancelTask:output_type -> aggregator.CancelTaskResp
	63,  // 221: aggregator.Aggregator.DeleteTask:output_type -> aggregator.DeleteTaskResp
	51,  // 222: aggregator.Aggregator.TriggerTask:output_type -> aggregator.TriggerTaskResp
	61,  // 223: aggregator.Aggregator.CreateSecret:output_type -> aggregator.CreateSecretResp
	58,  // 224: aggregator.Aggregator.DeleteSecret:output_type -> aggregator.DeleteSecretResp
	56,  // 225: aggregator.Aggregator.ListSecrets:output_type -> aggregator.ListSecretsResp
	62,  // 226: aggregator.Aggregator.UpdateSecret:output_type -> aggregator.UpdateSecretResp
	66,  // 227: aggregator.Aggregator.GetWorkflowCount:output_type -> aggregator.GetWorkflowCountResp
	68,  // 228: aggregator.Aggregator.GetExecutionCount:output_type -> aggregator.GetExecutionCountResp
	70,  // 229: aggregator.Aggregator.GetExecutionStats:output_type -> aggregator.GetExecutionStatsResp
	72,  // 230: aggregator.Aggregator.RunNodeWithInputs:output_type -> aggregator.RunNodeWithInputsResp
	74,  // 231: aggregator.Aggregator.RunTrigger:output_type -> aggregator.RunTriggerResp
	28,  // 232: aggregator.Aggregator.SimulateTask:output_type -> aggregator.Execution
	9,   // 233: aggregator.Aggregator.GetTokenMetadata:output_type -> aggregator.GetTokenMetadataResp
	83,  // 234: aggregator.Aggregator.EstimateFees:output_type -> aggregator.EstimateFeesResp
	207, // [207:235] is the sub-list for method output_type
	179, // [179:207] is the sub-list for method input_type
...
func file_avs_proto_init() {
	...
	file_avs_proto_msgTypes[43].OneofWrappers = []any{
	...
	file_avs_proto_msgTypes[84].OneofWrappers = []any{}
	...
	file_avs_proto_msgTypes[119].OneofWrappers = []any{
