...
func (x *ContractReadNode_MethodResult) Reset() {
	*x = ContractReadNode_MethodResult{}
	mi := &file_protobuf_avs_proto_msgTypes[91]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *ContractReadNode_Output) Reset() {
	*x = ContractReadNode_Output{}
	mi := &file_protobuf_avs_proto_msgTypes[92]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *FilterNode_Output) Reset() {
	*x = FilterNode_Output{}
	mi := &file_protobuf_avs_proto_msgTypes[106]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *Execution_Step) Reset() {
	*x = Execution_Step{}
	mi := &file_protobuf_avs_proto_msgTypes[109]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_protobuf_avs_proto_rawDesc = "" +
	...
	"\x06Output\x12*\n" +
	"\x04data\x18\x01 \x01(\v2\x16.google.protobuf.ValueR\x04data\"\xc6\x05\n" +
	"\fEventTrigger\x127\n" +
	...
	"\x06Output\x12*\n" +
	"\x04data\x18\x01 \x01(\v2\x16.google.protobuf.ValueR\x04data\"\x85\x06\n" +
	...
	"\rmethod_params\x18\x04 \x03(\tR\fmethodParams\x1a\xba\x01\n" +
	"\x06Config\x12)\n" +
	...
	"\x05steps\x18\b \x03(\v2\x1a.aggregator.Execution.StepR\x05steps\x1a\xcb\t\n" +
	"\x04Step\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x12\n" +
	...
	"\x06config\x18\x13 \x01(\v2\x16.google.protobuf.ValueR\x06config\x12F\n" +
	...
	"\x17EXECUTION_STATUS_FAILED\x10\x032\xa6\x0f\n" +
	"\n" +
	"Aggregator\x126\n" +
...
var file_protobuf_avs_proto_msgTypes = make([]protoimpl.MessageInfo, 115)
var file_protobuf_avs_proto_goTypes = []any{
	...
	(*TriggerTaskReq)(nil),                                // 48: aggregator.TriggerTaskReq
	(*TriggerTaskResp)(nil),                               // 49: aggregator.TriggerTaskResp
	(*CreateOrUpdateSecretReq)(nil),                       // 50: aggregator.CreateOrUpdateSecretReq
	(*ListSecretsReq)(nil),                                // 51: aggregator.ListSecretsReq
	(*PageInfo)(nil),                                      // 52: aggregator.PageInfo
	(*Secret)(nil),                                        // 53: aggregator.Secret
	(*ListSecretsResp)(nil),                               // 54: aggregator.ListSecretsResp
	(*DeleteSecretReq)(nil),                               // 55: aggregator.DeleteSecretReq
	(*DeleteSecretResp)(nil),                              // 56: aggregator.DeleteSecretResp
	(*GetSignatureFormatReq)(nil),                         // 57: aggregator.GetSignatureFormatReq
	(*GetSignatureFormatResp)(nil),                        // 58: aggregator.GetSignatureFormatResp
	(*CreateSecretResp)(nil),                              // 59: aggregator.CreateSecretResp
	(*UpdateSecretResp)(nil),                              // 60: aggregator.UpdateSecretResp
	(*DeleteTaskResp)(nil),                                // 61: aggregator.DeleteTaskResp
	(*CancelTaskResp)(nil),                                // 62: aggregator.CancelTaskResp
	(*GetWorkflowCountReq)(nil),                           // 63: aggregator.GetWorkflowCountReq
	(*GetWorkflowCountResp)(nil),                          // 64: aggregator.GetWorkflowCountResp
	(*GetExecutionCountReq)(nil),                          // 65: aggregator.GetExecutionCountReq
	(*GetExecutionCountResp)(nil),                         // 66: aggregator.GetExecutionCountResp
	(*GetExecutionStatsReq)(nil),                          // 67: aggregator.GetExecutionStatsReq
	(*GetExecutionStatsResp)(nil),                         // 68: aggregator.GetExecutionStatsResp
	(*RunNodeWithInputsReq)(nil),                          // 69: aggregator.RunNodeWithInputsReq
	(*RunNodeWithInputsResp)(nil),                         // 70: aggregator.RunNodeWithInputsResp
	(*RunTriggerReq)(nil),                                 // 71: aggregator.RunTriggerReq
	(*RunTriggerResp)(nil),                                // 72: aggregator.RunTriggerResp
	(*SimulateTaskReq)(nil),                               // 73: aggregator.SimulateTaskReq
	(*EventCondition)(nil),                                // 74: aggregator.EventCondition
	(*FixedTimeTrigger_Config)(nil),                       // 75: aggregator.FixedTimeTrigger.Config
	(*FixedTimeTrigger_Output)(nil),                       // 76: aggregator.FixedTimeTrigger.Output
	(*CronTrigger_Config)(nil),                            // 77: aggregator.CronTrigger.Config
	(*CronTrigger_Output)(nil),                            // 78: aggregator.CronTrigger.Output
	(*BlockTrigger_Config)(nil),                           // 79: aggregator.BlockTrigger.Config
	(*BlockTrigger_Output)(nil),                           // 80: aggregator.BlockTrigger.Output
	(*EventTrigger_Query)(nil),                            // 81: aggregator.EventTrigger.Query
	(*EventTrigger_MethodCall)(nil),                       // 82: aggregator.EventTrigger.MethodCall
	(*EventTrigger_Topics)(nil),                           // 83: aggregator.EventTrigger.Topics
	(*EventTrigger_Config)(nil),                           // 84: aggregator.EventTrigger.Config
	(*EventTrigger_Output)(nil),                           // 85: aggregator.EventTrigger.Output
	(*ManualTrigger_Config)(nil),                          // 86: aggregator.ManualTrigger.Config
	(*ManualTrigger_Output)(nil),                          // 87: aggregator.ManualTrigger.Output
	nil,                                                   // 88: aggregator.ManualTrigger.Config.HeadersEntry
	nil,                                                   // 89: aggregator.ManualTrigger.Config.PathParamsEntry
	(*ETHTransferNode_Config)(nil),                        // 90: aggregator.ETHTransferNode.Config
	(*ETHTransferNode_Output)(nil),                        // 91: aggregator.ETHTransferNode.Output
	(*ContractWriteNode_Config)(nil),                      // 92: aggregator.ContractWriteNode.Config
	(*ContractWriteNode_MethodCall)(nil),                  // 93: aggregator.ContractWriteNode.MethodCall
	(*ContractWriteNode_Output)(nil),                      // 94: aggregator.ContractWriteNode.Output
	(*ContractWriteNode_MethodResult)(nil),                // 95: aggregator.ContractWriteNode.MethodResult
	(*ContractReadNode_MethodCall)(nil),                   // 96: aggregator.ContractReadNode.MethodCall
	(*ContractReadNode_Config)(nil),                       // 97: aggregator.ContractReadNode.Config
	(*ContractReadNode_MethodResult)(nil),                 // 98: aggregator.ContractReadNode.MethodResult
	(*ContractReadNode_Output)(nil),                       // 99: aggregator.ContractReadNode.Output
	(*ContractReadNode_MethodResult_StructuredField)(nil), // 100: aggregator.ContractReadNode.MethodResult.StructuredField
	(*GraphQLQueryNode_Config)(nil),                       // 101: aggregator.GraphQLQueryNode.Config
	(*GraphQLQueryNode_Output)(nil),                       // 102: aggregator.GraphQLQueryNode.Output
	nil,                                                   // 103: aggregator.GraphQLQueryNode.Config.VariablesEntry
	(*RestAPINode_Config)(nil),                            // 104: aggregator.RestAPINode.Config
	(*RestAPINode_Output)(nil),                            // 105: aggregator.RestAPINode.Output
	nil,                                                   // 106: aggregator.RestAPINode.Config.HeadersEntry
	(*CustomCodeNode_Config)(nil),                         // 107: aggregator.CustomCodeNode.Config
	(*CustomCodeNode_Output)(nil),                         // 108: aggregator.CustomCodeNode.Output
	(*BranchNode_Condition)(nil),                          // 109: aggregator.BranchNode.Condition
	(*BranchNode_Config)(nil),                             // 110: aggregator.BranchNode.Config
	(*BranchNode_Output)(nil),                             // 111: aggregator.BranchNode.Output
	(*FilterNode_Config)(nil),                             // 112: aggregator.FilterNode.Config
	(*FilterNode_Output)(nil),                             // 113: aggregator.FilterNode.Output
	(*LoopNode_Config)(nil),                               // 114: aggregator.LoopNode.Config
	(*LoopNode_Output)(nil),                               // 115: aggregator.LoopNode.Output
	(*Execution_Step)(nil),                                // 116: aggregator.Execution.Step
	nil,                                                   // 117: aggregator.RunNodeWithInputsReq.NodeConfigEntry
	nil,                                                   // 118: aggregator.RunNodeWithInputsReq.InputVariablesEntry
	nil,                                                   // 119: aggregator.RunTriggerReq.TriggerConfigEntry
	nil,                                                   // 120: aggregator.RunTriggerReq.TriggerInputEntry
	nil,                                                   // 121: aggregator.SimulateTaskReq.InputVariablesEntry
...
var file_protobuf_avs_proto_depIdxs = []int32{
	...
	75,  // 1: aggregator.FixedTimeTrigger.config:type_name -> aggregator.FixedTimeTrigger.Config
	77,  // 2: aggregator.CronTrigger.config:type_name -> aggregator.CronTrigger.Config
	79,  // 3: aggregator.BlockTrigger.config:type_name -> aggregator.BlockTrigger.Config
	84,  // 4: aggregator.EventTrigger.config:type_name -> aggregator.EventTrigger.Config
	86,  // 5: aggregator.ManualTrigger.config:type_name -> aggregator.ManualTrigger.Config
	...
	90,  // 12: aggregator.ETHTransferNode.config:type_name -> aggregator.ETHTransferNode.Config
	92,  // 13: aggregator.ContractWriteNode.config:type_name -> aggregator.ContractWriteNode.Config
	97,  // 14: aggregator.ContractReadNode.config:type_name -> aggregator.ContractReadNode.Config
	101, // 15: aggregator.GraphQLQueryNode.config:type_name -> aggregator.GraphQLQueryNode.Config
	104, // 16: aggregator.RestAPINode.config:type_name -> aggregator.RestAPINode.Config
	107, // 17: aggregator.CustomCodeNode.config:type_name -> aggregator.CustomCodeNode.Config
	110, // 18: aggregator.BranchNode.config:type_name -> aggregator.BranchNode.Config
	112, // 19: aggregator.FilterNode.config:type_name -> aggregator.FilterNode.Config
	...
	114, // 26: aggregator.LoopNode.config:type_name -> aggregator.LoopNode.Config
	...
	116, // 37: aggregator.Execution.steps:type_name -> aggregator.Execution.Step
	5,   // 38: aggregator.Task.status:type_name -> aggregator.TaskStatus
	16,  // 39: aggregator.Task.trigger:type_name -> aggregator.TaskTrigger
	27,  // 40: aggregator.Task.nodes:type_name -> aggregator.TaskNode
	26,  // 41: aggregator.Task.edges:type_name -> aggregator.TaskEdge
	16,  // 42: aggregator.CreateTaskReq.trigger:type_name -> aggregator.TaskTrigger
	27,  // 43: aggregator.CreateTaskReq.nodes:type_name -> aggregator.TaskNode
	26,  // 44: aggregator.CreateTaskReq.edges:type_name -> aggregator.TaskEdge
	35,  // 45: aggregator.ListWalletResp.items:type_name -> aggregator.SmartWallet
	29,  // 46: aggregator.ListTasksResp.items:type_name -> aggregator.Task
	52,  // 47: aggregator.ListTasksResp.page_info:type_name -> aggregator.PageInfo
	28,  // 48: aggregator.ListExecutionsResp.items:type_name -> aggregator.Execution
	52,  // 49: aggregator.ListExecutionsResp.page_info:type_name -> aggregator.PageInfo
	6,   // 50: aggregator.ExecutionStatusResp.status:type_name -> aggregator.ExecutionStatus
	0,   // 51: aggregator.TriggerTaskReq.trigger_type:type_name -> aggregator.TriggerType
	80,  // 52: aggregator.TriggerTaskReq.block_trigger:type_name -> aggregator.BlockTrigger.Output
	76,  // 53: aggregator.TriggerTaskReq.fixed_time_trigger:type_name -> aggregator.FixedTimeTrigger.Output
	78,  // 54: aggregator.TriggerTaskReq.cron_trigger:type_name -> aggregator.CronTrigger.Output
	85,  // 55: aggregator.TriggerTaskReq.event_trigger:type_name -> aggregator.EventTrigger.Output
	87,  // 56: aggregator.TriggerTaskReq.manual_trigger:type_name -> aggregator.ManualTrigger.Output
	6,   // 57: aggregator.TriggerTaskResp.status:type_name -> aggregator.ExecutionStatus
	53,  // 58: aggregator.ListSecretsResp.items:type_name -> aggregator.Secret
	52,  // 59: aggregator.ListSecretsResp.page_info:type_name -> aggregator.PageInfo
	1,   // 60: aggregator.RunNodeWithInputsReq.node_type:type_name -> aggregator.NodeType
	117, // 61: aggregator.RunNodeWithInputsReq.node_config:type_name -> aggregator.RunNodeWithInputsReq.NodeConfigEntry
	118, // 62: aggregator.RunNodeWithInputsReq.input_variables:type_name -> aggregator.RunNodeWithInputsReq.InputVariablesEntry
	122, // 63: aggregator.RunNodeWithInputsResp.metadata:type_name -> google.protobuf.Value
	91,  // 64: aggregator.RunNodeWithInputsResp.eth_transfer:type_name -> aggregator.ETHTransferNode.Output
	102, // 65: aggregator.RunNodeWithInputsResp.graphql:type_name -> aggregator.GraphQLQueryNode.Output
	99,  // 66: aggregator.RunNodeWithInputsResp.contract_read:type_name -> aggregator.ContractReadNode.Output
	94,  // 67: aggregator.RunNodeWithInputsResp.contract_write:type_name -> aggregator.ContractWriteNode.Output
	108, // 68: aggregator.RunNodeWithInputsResp.custom_code:type_name -> aggregator.CustomCodeNode.Output
	105, // 69: aggregator.RunNodeWithInputsResp.rest_api:type_name -> aggregator.RestAPINode.Output
	111, // 70: aggregator.RunNodeWithInputsResp.branch:type_name -> aggregator.BranchNode.Output
	113, // 71: aggregator.RunNodeWithInputsResp.filter:type_name -> aggregator.FilterNode.Output
	115, // 72: aggregator.RunNodeWithInputsResp.loop:type_name -> aggregator.LoopNode.Output
	0,   // 73: aggregator.RunTriggerReq.trigger_type:type_name -> aggregator.TriggerType
	119, // 74: aggregator.RunTriggerReq.trigger_config:type_name -> aggregator.RunTriggerReq.TriggerConfigEntry
	120, // 75: aggregator.RunTriggerReq.trigger_input:type_name -> aggregator.RunTriggerReq.TriggerInputEntry
	122, // 76: aggregator.RunTriggerResp.metadata:type_name -> google.protobuf.Value
	80,  // 77: aggregator.RunTriggerResp.block_trigger:type_name -> aggregator.BlockTrigger.Output
	76,  // 78: aggregator.RunTriggerResp.fixed_time_trigger:type_name -> aggregator.FixedTimeTrigger.Output
	78,  // 79: aggregator.RunTriggerResp.cron_trigger:type_name -> aggregator.CronTrigger.Output
	85,  // 80: aggregator.RunTriggerResp.event_trigger:type_name -> aggregator.EventTrigger.Output
	87,  // 81: aggregator.RunTriggerResp.manual_trigger:type_name -> aggregator.ManualTrigger.Output
	16,  // 82: aggregator.SimulateTaskReq.trigger:type_name -> aggregator.TaskTrigger
	27,  // 83: aggregator.SimulateTaskReq.nodes:type_name -> aggregator.TaskNode
	26,  // 84: aggregator.SimulateTaskReq.edges:type_name -> aggregator.TaskEdge
	121, // 85: aggregator.SimulateTaskReq.input_variables:type_name -> aggregator.SimulateTaskReq.InputVariablesEntry
	122, // 86: aggregator.FixedTimeTrigger.Output.data:type_name -> google.protobuf.Value
	122, // 87: aggregator.CronTrigger.Output.data:type_name -> google.protobuf.Value
	122, // 88: aggregator.BlockTrigger.Output.data:type_name -> google.protobuf.Value
	83,  // 89: aggregator.EventTrigger.Query.topics:type_name -> aggregator.EventTrigger.Topics
	122, // 90: aggregator.EventTrigger.Query.contract_abi:type_name -> google.protobuf.Value
	74,  // 91: aggregator.EventTrigger.Query.conditions:type_name -> aggregator.EventCondition
	82,  // 92: aggregator.EventTrigger.Query.method_calls:type_name -> aggregator.EventTrigger.MethodCall
	81,  // 93: aggregator.EventTrigger.Config.queries:type_name -> aggregator.EventTrigger.Query
	122, // 94: aggregator.EventTrigger.Output.data:type_name -> google.protobuf.Value
	122, // 95: aggregator.ManualTrigger.Config.data:type_name -> google.protobuf.Value
	88,  // 96: aggregator.ManualTrigger.Config.headers:type_name -> aggregator.ManualTrigger.Config.HeadersEntry
	89,  // 97: aggregator.ManualTrigger.Config.pathParams:type_name -> aggregator.ManualTrigger.Config.PathParamsEntry
	122, // 98: aggregator.ManualTrigger.Output.data:type_name -> google.protobuf.Value
	122, // 99: aggregator.ETHTransferNode.Output.data:type_name -> google.protobuf.Value
	122, // 100: aggregator.ContractWriteNode.Config.contract_abi:type_name -> google.protobuf.Value
	93,  // 101: aggregator.ContractWriteNode.Config.method_calls:type_name -> aggregator.ContractWriteNode.MethodCall
	122, // 102: aggregator.ContractWriteNode.Output.data:type_name -> google.protobuf.Value
	122, // 103: aggregator.ContractWriteNode.MethodResult.method_abi:type_name -> google.protobuf.Value
	122, // 104: aggregator.ContractWriteNode.MethodResult.receipt:type_name -> google.protobuf.Value
	122, // 105: aggregator.ContractWriteNode.MethodResult.value:type_name -> google.protobuf.Value
	122, // 106: aggregator.ContractReadNode.Config.contract_abi:type_name -> google.protobuf.Value
	96,  // 107: aggregator.ContractReadNode.Config.method_calls:type_name -> aggregator.ContractReadNode.MethodCall
	100, // 108: aggregator.ContractReadNode.MethodResult.data:type_name -> aggregator.ContractReadNode.MethodResult.StructuredField
	122, // 109: aggregator.ContractReadNode.Output.data:type_name -> google.protobuf.Value
	103, // 110: aggregator.GraphQLQueryNode.Config.variables:type_name -> aggregator.GraphQLQueryNode.Config.VariablesEntry
	122, // 111: aggregator.GraphQLQueryNode.Output.data:type_name -> google.protobuf.Value
	106, // 112: aggregator.RestAPINode.Config.headers:type_name -> aggregator.RestAPINode.Config.HeadersEntry
	122, // 113: aggregator.RestAPINode.Output.data:type_name -> google.protobuf.Value
	3,   // 114: aggregator.CustomCodeNode.Config.lang:type_name -> aggregator.Lang
	122, // 115: aggregator.CustomCodeNode.Output.data:type_name -> google.protobuf.Value
	109, // 116: aggregator.BranchNode.Config.conditions:type_name -> aggregator.BranchNode.Condition
	122, // 117: aggregator.BranchNode.Output.data:type_name -> google.protobuf.Value
	122, // 118: aggregator.FilterNode.Output.data:type_name -> google.protobuf.Value
	2,   // 119: aggregator.LoopNode.Config.execution_mode:type_name -> aggregator.ExecutionMode
	122, // 120: aggregator.LoopNode.Output.data:type_name -> google.protobuf.Value
	122, // 121: aggregator.Execution.Step.config:type_name -> google.protobuf.Value
	80,  // 122: aggregator.Execution.Step.block_trigger:type_name -> aggregator.BlockTrigger.Output
	76,  // 123: aggregator.Execution.Step.fixed_time_trigger:type_name -> aggregator.FixedTimeTrigger.Output
	78,  // 124: aggregator.Execution.Step.cron_trigger:type_name -> aggregator.CronTrigger.Output
	85,  // 125: aggregator.Execution.Step.event_trigger:type_name -> aggregator.EventTrigger.Output
	87,  // 126: aggregator.Execution.Step.manual_trigger:type_name -> aggregator.ManualTrigger.Output
	91,  // 127: aggregator.Execution.Step.eth_transfer:type_name -> aggregator.ETHTransferNode.Output
	102, // 128: aggregator.Execution.Step.graphql:type_name -> aggregator.GraphQLQueryNode.Output
	99,  // 129: aggregator.Execution.Step.contract_read:type_name -> aggregator.ContractReadNode.Output
	94,  // 130: aggregator.Execution.Step.contract_write:type_name -> aggregator.ContractWriteNode.Output
	108, // 131: aggregator.Execution.Step.custom_code:type_name -> aggregator.CustomCodeNode.Output
	105, // 132: aggregator.Execution.Step.rest_api:type_name -> aggregator.RestAPINode.Output
	111, // 133: aggregator.Execution.Step.branch:type_name -> aggregator.BranchNode.Output
	113, // 134: aggregator.Execution.Step.filter:type_name -> aggregator.FilterNode.Output
	115, // 135: aggregator.Execution.Step.loop:type_name -> aggregator.LoopNode.Output
	122, // 136: aggregator.RunNodeWithInputsReq.NodeConfigEntry.value:type_name -> google.protobuf.Value
	122, // 137: aggregator.RunNodeWithInputsReq.InputVariablesEntry.value:type_name -> google.protobuf.Value
	122, // 138: aggregator.RunTriggerReq.TriggerConfigEntry.value:type_name -> google.protobuf.Value
	122, // 139: aggregator.RunTriggerReq.TriggerInputEntry.value:type_name -> google.protobuf.Value
	122, // 140: aggregator.SimulateTaskReq.InputVariablesEntry.value:type_name -> google.protobuf.Value
	43,  // 141: aggregator.Aggregator.GetKey:input_type -> aggregator.GetKeyReq
	57,  // 142: aggregator.Aggregator.GetSignatureFormat:input_type -> aggregator.GetSignatureFormatReq
	32,  // 143: aggregator.Aggregator.GetNonce:input_type -> aggregator.NonceRequest
	45,  // 144: aggregator.Aggregator.GetWallet:input_type -> aggregator.GetWalletReq
	47,  // 145: aggregator.Aggregator.SetWallet:input_type -> aggregator.SetWalletReq
	34,  // 146: aggregator.Aggregator.ListWallets:input_type -> aggregator.ListWalletReq
	30,  // 147: aggregator.Aggregator.CreateTask:input_type -> aggregator.CreateTaskReq
	37,  // 148: aggregator.Aggregator.ListTasks:input_type -> aggregator.ListTasksReq
	10,  // 149: aggregator.Aggregator.GetTask:input_type -> aggregator.IdReq
	39,  // 150: aggregator.Aggregator.ListExecutions:input_type -> aggregator.ListExecutionsReq
	41,  // 151: aggregator.Aggregator.GetExecution:input_type -> aggregator.ExecutionReq
	41,  // 152: aggregator.Aggregator.GetExecutionStatus:input_type -> aggregator.ExecutionReq
	10,  // 153: aggregator.Aggregator.CancelTask:input_type -> aggregator.IdReq
	10,  // 154: aggregator.Aggregator.DeleteTask:input_type -> aggregator.IdReq
	48,  // 155: aggregator.Aggregator.TriggerTask:input_type -> aggregator.TriggerTaskReq
	50,  // 156: aggregator.Aggregator.CreateSecret:input_type -> aggregator.CreateOrUpdateSecretReq
	55,  // 157: aggregator.Aggregator.DeleteSecret:input_type -> aggregator.DeleteSecretReq
	51,  // 158: aggregator.Aggregator.ListSecrets:input_type -> aggregator.ListSecretsReq
	50,  // 159: aggregator.Aggregator.UpdateSecret:input_type -> aggregator.CreateOrUpdateSecretReq
	63,  // 160: aggregator.Aggregator.GetWorkflowCount:input_type -> aggregator.GetWorkflowCountReq
	65,  // 161: aggregator.Aggregator.GetExecutionCount:input_type -> aggregator.GetExecutionCountReq
	67,  // 162: aggregator.Aggregator.GetExecutionStats:input_type -> aggregator.GetExecutionStatsReq
	69,  // 163: aggregator.Aggregator.RunNodeWithInputs:input_type -> aggregator.RunNodeWithInputsReq
	71,  // 164: aggregator.Aggregator.RunTrigger:input_type -> aggregator.RunTriggerReq
	73,  // 165: aggregator.Aggregator.SimulateTask:input_type -> aggregator.SimulateTaskReq
	8,   // 166: aggregator.Aggregator.GetTokenMetadata:input_type -> aggregator.GetTokenMetadataReq
	44,  // 167: aggregator.Aggregator.GetKey:output_type -> aggregator.KeyResp
	58,  // 168: aggregator.Aggregator.GetSignatureFormat:output_type -> aggregator.GetSignatureFormatResp
	33,  // 169: aggregator.Aggregator.GetNonce:output_type -> aggregator.NonceResp
	46,  // 170: aggregator.Aggregator.GetWallet:output_type -> aggregator.GetWalletResp
	46,  // 171: aggregator.Aggregator.SetWallet:output_type -> aggregator.GetWalletResp
	36,  // 172: aggregator.Aggregator.ListWallets:output_type -> aggregator.ListWalletResp
	31,  // 173: aggregator.Aggregator.CreateTask:output_type -> aggregator.CreateTaskResp
	38,  // 174: aggregator.Aggregator.ListTasks:output_type -> aggregator.ListTasksResp
	29,  // 175: aggregator.Aggregator.GetTask:output_type -> aggregator.Task
	40,  // 176: aggregator.Aggregator.ListExecutions:output_type -> aggregator.ListExecutionsResp
	28,  // 177: aggregator.Aggregator.GetExecution:output_type -> aggregator.Execution
	42,  // 178: aggregator.Aggregator.GetExecutionStatus:output_type -> aggregator.ExecutionStatusResp
	62,  // 179: aggregator.Aggregator.CancelTask:output_type -> aggregator.CancelTaskResp
	61,  // 180: aggregator.Aggregator.DeleteTask:output_type -> aggregator.DeleteTaskResp
	49,  // 181: aggregator.Aggregator.TriggerTask:output_type -> aggregator.TriggerTaskResp
	59,  // 182: aggregator.Aggregator.CreateSecret:output_type -> aggregator.CreateSecretResp
	56,  // 183: aggregator.Aggregator.DeleteSecret:output_type -> aggregator.DeleteSecretResp
	54,  // 184: aggregator.Aggregator.ListSecrets:output_type -> aggregator.ListSecretsResp
	60,  // 185: aggregator.Aggregator.UpdateSecret:output_type -> aggregator.UpdateSecretResp
	64,  // 186: aggregator.Aggregator.GetWorkflowCount:output_type -> aggregator.GetWorkflowCountResp
	66,  // 187: aggregator.Aggregator.GetExecutionCount:output_type -> aggregator.GetExecutionCountResp
	68,  // 188: aggregator.Aggregator.GetExecutionStats:output_type -> aggregator.GetExecutionStatsResp
	70,  // 189: aggregator.Aggregator.RunNodeWithInputs:output_type -> aggregator.RunNodeWithInputsResp
	72,  // 190: aggregator.Aggregator.RunTrigger:output_type -> aggregator.RunTriggerResp
	28,  // 191: aggregator.Aggregator.SimulateTask:output_type -> aggregator.Execution
	9,   // 192: aggregator.Aggregator.GetTokenMetadata:output_type -> aggregator.GetTokenMetadataResp
...
func file_protobuf_avs_proto_init() {
	...
	file_protobuf_avs_proto_msgTypes[41].OneofWrappers = []any{
	...
	file_protobuf_avs_proto_msgTypes[63].OneofWrappers = []any{
	...
	file_protobuf_avs_proto_msgTypes[74].OneofWrappers = []any{}
	file_protobuf_avs_proto_msgTypes[88].OneofWrappers = []any{}
	file_protobuf_avs_proto_msgTypes[109].OneofWrappers = []any{
