...
func (*Evm_Log) Descriptor() ([]byte, []int) {
	return file_avs_proto_rawDescGZIP(), []int{51, 0}
}
...
func (*Evm_TransactionReceipt) Descriptor() ([]byte, []int) {
	return file_avs_proto_rawDescGZIP(), []int{51, 1}
}
...
func (*Evm_UserOp) Descriptor() ([]byte, []int) {
	return file_avs_proto_rawDescGZIP(), []int{51, 2}
}
...
const file_avs_proto_rawDesc = "" +
	...
	"\x13canceled_task_count\x18\b \x01(\x04R\x11canceledTaskCount\"h\n" +
	...
	"\tGetWallet\x12\x18.aggregator.GetWalletReq\x1a\x19.aggregator.GetWalletResp\"\x00\x12C\n" +
	"\n" +
	"HideWallet\x12\x18.aggregator.GetWalletReq\x1a\x19.aggregator.GetWalletResp\"\x00\x12E\n" +
	"\fUnhideWallet\x12\x18.aggregator.GetWalletReq\x1a\x19.aggregator.GetWalletResp\"\x00\x12B\n" +
...
var file_avs_proto_msgTypes = make([]protoimpl.MessageInfo, 73)
var file_avs_proto_goTypes = []any{
	...
	(*GetWorkflowCountReq)(nil),            // 50: aggregator.GetWorkflowCountReq
	(*GetWorkflowCountResp)(nil),           // 51: aggregator.GetWorkflowCountResp
	(*GetExecutionCountReq)(nil),           // 52: aggregator.GetExecutionCountReq
	(*GetExecutionCountResp)(nil),          // 53: aggregator.GetExecutionCountResp
	(*GetExecutionStatsReq)(nil),           // 54: aggregator.GetExecutionStatsReq
	(*GetExecutionStatsResp)(nil),          // 55: aggregator.GetExecutionStatsResp
	(*Evm)(nil),                            // 56: aggregator.Evm
	(*EventCondition_Matcher)(nil),         // 57: aggregator.EventCondition.Matcher
	(*ETHTransferNode_Output)(nil),         // 58: aggregator.ETHTransferNode.Output
	(*ContractWriteNode_Output)(nil),       // 59: aggregator.ContractWriteNode.Output
	(*ContractReadNode_Output)(nil),        // 60: aggregator.ContractReadNode.Output
	nil,                                    // 61: aggregator.GraphQLQueryNode.VariablesEntry
	(*GraphQLQueryNode_Output)(nil),        // 62: aggregator.GraphQLQueryNode.Output
	nil,                                    // 63: aggregator.RestAPINode.HeadersEntry
	(*RestAPINode_Output)(nil),             // 64: aggregator.RestAPINode.Output
	(*CustomCodeNode_Output)(nil),          // 65: aggregator.CustomCodeNode.Output
	(*BranchNode_Output)(nil),              // 66: aggregator.BranchNode.Output
	(*FilterNode_Output)(nil),              // 67: aggregator.FilterNode.Output
	(*LoopNode_Output)(nil),                // 68: aggregator.LoopNode.Output
	(*Execution_Step)(nil),                 // 69: aggregator.Execution.Step
	(*Execution_TransferLogOutput)(nil),    // 70: aggregator.Execution.TransferLogOutput
	(*Execution_BlockOutput)(nil),          // 71: aggregator.Execution.BlockOutput
	(*Execution_TimeOutput)(nil),           // 72: aggregator.Execution.TimeOutput
	(*ListTasksResp_Item)(nil),             // 73: aggregator.ListTasksResp.Item
	(*ListSecretsResp_ResponseSecret)(nil), // 74: aggregator.ListSecretsResp.ResponseSecret
	(*Evm_Log)(nil),                        // 75: aggregator.Evm.Log
	(*Evm_TransactionReceipt)(nil),         // 76: aggregator.Evm.TransactionReceipt
	(*Evm_UserOp)(nil),                     // 77: aggregator.Evm.UserOp
...
var file_avs_proto_depIdxs = []int32{
	57, // 0: aggregator.EventCondition.matcher:type_name -> aggregator.EventCondition.Matcher
	...
	61, // 5: aggregator.GraphQLQueryNode.variables:type_name -> aggregator.GraphQLQueryNode.VariablesEntry
	63, // 6: aggregator.RestAPINode.headers:type_name -> aggregator.RestAPINode.HeadersEntry
	...
	69, // 25: aggregator.Execution.steps:type_name -> aggregator.Execution.Step
	70, // 26: aggregator.Execution.transfer_log:type_name -> aggregator.Execution.TransferLogOutput
	75, // 27: aggregator.Execution.evm_log:type_name -> aggregator.Evm.Log
	71, // 28: aggregator.Execution.block:type_name -> aggregator.Execution.BlockOutput
	72, // 29: aggregator.Execution.time:type_name -> aggregator.Execution.TimeOutput
	...
	73, // 38: aggregator.ListTasksResp.items:type_name -> aggregator.ListTasksResp.Item
	...
	78, // 41: aggregator.GetKeyReq.issued_at:type_name -> google.protobuf.Timestamp
	78, // 42: aggregator.GetKeyReq.expired_at:type_name -> google.protobuf.Timestamp
	...
	74, // 46: aggregator.ListSecretsResp.items:type_name -> aggregator.ListSecretsResp.ResponseSecret
	77, // 47: aggregator.ContractWriteNode.Output.user_op:type_name -> aggregator.Evm.UserOp
	76, // 48: aggregator.ContractWriteNode.Output.tx_receipt:type_name -> aggregator.Evm.TransactionReceipt
	79, // 49: aggregator.ContractReadNode.Output.data:type_name -> google.protobuf.Value
	80, // 50: aggregator.GraphQLQueryNode.Output.data:type_name -> google.protobuf.Any
	80, // 51: aggregator.RestAPINode.Output.data:type_name -> google.protobuf.Any
	79, // 52: aggregator.CustomCodeNode.Output.data:type_name -> google.protobuf.Value
	80, // 53: aggregator.FilterNode.Output.data:type_name -> google.protobuf.Any
	58, // 54: aggregator.Execution.Step.eth_transfer:type_name -> aggregator.ETHTransferNode.Output
	62, // 55: aggregator.Execution.Step.graphql:type_name -> aggregator.GraphQLQueryNode.Output
	60, // 56: aggregator.Execution.Step.contract_read:type_name -> aggregator.ContractReadNode.Output
	59, // 57: aggregator.Execution.Step.contract_write:type_name -> aggregator.ContractWriteNode.Output
	65, // 58: aggregator.Execution.Step.custom_code:type_name -> aggregator.CustomCodeNode.Output
	64, // 59: aggregator.Execution.Step.rest_api:type_name -> aggregator.RestAPINode.Output
	66, // 60: aggregator.Execution.Step.branch:type_name -> aggregator.BranchNode.Output
	67, // 61: aggregator.Execution.Step.filter:type_name -> aggregator.FilterNode.Output
	68, // 62: aggregator.Execution.Step.loop:type_name -> aggregator.LoopNode.Output
	...
	41, // 68: aggregator.Aggregator.HideWallet:input_type -> aggregator.GetWalletReq
	41, // 69: aggregator.Aggregator.UnhideWallet:input_type -> aggregator.GetWalletReq
	43, // 70: aggregator.Aggregator.SetWallet:input_type -> aggregator.SetWalletReq
	29, // 71: aggregator.Aggregator.ListWallets:input_type -> aggregator.ListWalletReq
	25, // 72: aggregator.Aggregator.CreateTask:input_type -> aggregator.CreateTaskReq
	32, // 73: aggregator.Aggregator.ListTasks:input_type -> aggregator.ListTasksReq
	5,  // 74: aggregator.Aggregator.GetTask:input_type -> aggregator.IdReq
	34, // 75: aggregator.Aggregator.ListExecutions:input_type -> aggregator.ListExecutionsReq
	36, // 76: aggregator.Aggregator.GetExecution:input_type -> aggregator.ExecutionReq
	36, // 77: aggregator.Aggregator.GetExecutionStatus:input_type -> aggregator.ExecutionReq
	5,  // 78: aggregator.Aggregator.CancelTask:input_type -> aggregator.IdReq
	5,  // 79: aggregator.Aggregator.DeleteTask:input_type -> aggregator.IdReq
	44, // 80: aggregator.Aggregator.TriggerTask:input_type -> aggregator.UserTriggerTaskReq
	46, // 81: aggregator.Aggregator.CreateSecret:input_type -> aggregator.CreateOrUpdateSecretReq
	49, // 82: aggregator.Aggregator.DeleteSecret:input_type -> aggregator.DeleteSecretReq
	47, // 83: aggregator.Aggregator.ListSecrets:input_type -> aggregator.ListSecretsReq
	46, // 84: aggregator.Aggregator.UpdateSecret:input_type -> aggregator.CreateOrUpdateSecretReq
	50, // 85: aggregator.Aggregator.GetWorkflowCount:input_type -> aggregator.GetWorkflowCountReq
	52, // 86: aggregator.Aggregator.GetExecutionCount:input_type -> aggregator.GetExecutionCountReq
	54, // 87: aggregator.Aggregator.GetExecutionStats:input_type -> aggregator.GetExecutionStatsReq
	39, // 88: aggregator.Aggregator.GetKey:output_type -> aggregator.KeyResp
	28, // 89: aggregator.Aggregator.GetNonce:output_type -> aggregator.NonceResp
	42, // 90: aggregator.Aggregator.GetWallet:output_type -> aggregator.GetWalletResp
	42, // 91: aggregator.Aggregator.HideWallet:output_type -> aggregator.GetWalletResp
	42, // 92: aggregator.Aggregator.UnhideWallet:output_type -> aggregator.GetWalletResp
	42, // 93: aggregator.Aggregator.SetWallet:output_type -> aggregator.GetWalletResp
	31, // 94: aggregator.Aggregator.ListWallets:output_type -> aggregator.ListWalletResp
	26, // 95: aggregator.Aggregator.CreateTask:output_type -> aggregator.CreateTaskResp
	33, // 96: aggregator.Aggregator.ListTasks:output_type -> aggregator.ListTasksResp
	24, // 97: aggregator.Aggregator.GetTask:output_type -> aggregator.Task
	35, // 98: aggregator.Aggregator.ListExecutions:output_type -> aggregator.ListExecutionsResp
	23, // 99: aggregator.Aggregator.GetExecution:output_type -> aggregator.Execution
	37, // 100: aggregator.Aggregator.GetExecutionStatus:output_type -> aggregator.ExecutionStatusResp
	81, // 101: aggregator.Aggregator.CancelTask:output_type -> google.protobuf.BoolValue
	81, // 102: aggregator.Aggregator.DeleteTask:output_type -> google.protobuf.BoolValue
	45, // 103: aggregator.Aggregator.TriggerTask:output_type -> aggregator.UserTriggerTaskResp
	81, // 104: aggregator.Aggregator.CreateSecret:output_type -> google.protobuf.BoolValue
	81, // 105: aggregator.Aggregator.DeleteSecret:output_type -> google.protobuf.BoolValue
	48, // 106: aggregator.Aggregator.ListSecrets:output_type -> aggregator.ListSecretsResp
	81, // 107: aggregator.Aggregator.UpdateSecret:output_type -> google.protobuf.BoolValue
	51, // 108: aggregator.Aggregator.GetWorkflowCount:output_type -> aggregator.GetWorkflowCountResp
	53, // 109: aggregator.Aggregator.GetExecutionCount:output_type -> aggregator.GetExecutionCountResp
	55, // 110: aggregator.Aggregator.GetExecutionStats:output_type -> aggregator.GetExecutionStatsResp
...
func file_avs_proto_init() {
	...
	file_avs_proto_msgTypes[64].OneofWrappers = []any{
