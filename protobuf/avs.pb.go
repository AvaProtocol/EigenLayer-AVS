...
var file_protobuf_avs_proto_rawDesc = []byte{
	...
	0x10, 0x00, 0x32, 0x85, 0x07, 0x0a, 0x0a, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x6f,
...
var file_protobuf_avs_proto_depIdxs = []int32{
	...
	50, // 37: aggregator.GetKeyReq.issued_at:type_name -> google.protobuf.Timestamp
	50, // 38: aggregator.GetKeyReq.expired_at:type_name -> google.protobuf.Timestamp
	...
	1,  // 42: aggregator.ListTasksResp.Item.status:type_name -> aggregator.TaskStatus
	10, // 43: aggregator.ListTasksResp.Item.trigger:type_name -> aggregator.TaskTrigger
	38, // 44: aggregator.Aggregator.GetKey:input_type -> aggregator.GetKeyReq
	27, // 45: aggregator.Aggregator.GetNonce:input_type -> aggregator.NonceRequest
	41, // 46: aggregator.Aggregator.GetWallet:input_type -> aggregator.GetWalletReq
	29, // 47: aggregator.Aggregator.ListWallets:input_type -> aggregator.ListWalletReq
	25, // 48: aggregator.Aggregator.CreateTask:input_type -> aggregator.CreateTaskReq
	32, // 49: aggregator.Aggregator.ListTasks:input_type -> aggregator.ListTasksReq
	5,  // 50: aggregator.Aggregator.GetTask:input_type -> aggregator.IdReq
	34, // 51: aggregator.Aggregator.ListExecutions:input_type -> aggregator.ListExecutionsReq
	36, // 52: aggregator.Aggregator.GetExecution:input_type -> aggregator.ExecutionReq
	36, // 53: aggregator.Aggregator.GetExecutionStatus:input_type -> aggregator.ExecutionReq
	5,  // 54: aggregator.Aggregator.CancelTask:input_type -> aggregator.IdReq
	5,  // 55: aggregator.Aggregator.DeleteTask:input_type -> aggregator.IdReq
	43, // 56: aggregator.Aggregator.TriggerTask:input_type -> aggregator.UserTriggerTaskReq
	39, // 57: aggregator.Aggregator.GetKey:output_type -> aggregator.KeyResp
	28, // 58: aggregator.Aggregator.GetNonce:output_type -> aggregator.NonceResp
	42, // 59: aggregator.Aggregator.GetWallet:output_type -> aggregator.GetWalletResp
	31, // 60: aggregator.Aggregator.ListWallets:output_type -> aggregator.ListWalletResp
	26, // 61: aggregator.Aggregator.CreateTask:output_type -> aggregator.CreateTaskResp
	33, // 62: aggregator.Aggregator.ListTasks:output_type -> aggregator.ListTasksResp
	24, // 63: aggregator.Aggregator.GetTask:output_type -> aggregator.Task
	35, // 64: aggregator.Aggregator.ListExecutions:output_type -> aggregator.ListExecutionsResp
	23, // 65: aggregator.Aggregator.GetExecution:output_type -> aggregator.Execution
	37, // 66: aggregator.Aggregator.GetExecutionStatus:output_type -> aggregator.ExecutionStatusResp
	51, // 67: aggregator.Aggregator.CancelTask:output_type -> google.protobuf.BoolValue
	51, // 68: aggregator.Aggregator.DeleteTask:output_type -> google.protobuf.BoolValue
	44, // 69: aggregator.Aggregator.TriggerTask:output_type -> aggregator.UserTriggerTaskResp
