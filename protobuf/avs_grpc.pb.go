...
const (
	...
	Aggregator_HideWallet_FullMethodName         = "/aggregator.Aggregator/HideWallet"
	Aggregator_UnhideWallet_FullMethodName       = "/aggregator.Aggregator/UnhideWallet"
...
type AggregatorClient interface {
	...
	HideWallet(ctx context.Context, in *GetWalletReq, opts ...grpc.CallOption) (*GetWalletResp, error)
	UnhideWallet(ctx context.Context, in *GetWalletReq, opts ...grpc.CallOption) (*GetWalletResp, error)
...
func (c *aggregatorClient) HideWallet(ctx context.Context, in *GetWalletReq, opts ...grpc.CallOption) (*GetWalletResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetWalletResp)
	err := c.cc.Invoke(ctx, Aggregator_HideWallet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aggregatorClient) UnhideWallet(ctx context.Context, in *GetWalletReq, opts ...grpc.CallOption) (*GetWalletResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetWalletResp)
	err := c.cc.Invoke(ctx, Aggregator_UnhideWallet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AggregatorServer interface {
	...
	HideWallet(context.Context, *GetWalletReq) (*GetWalletResp, error)
	UnhideWallet(context.Context, *GetWalletReq) (*GetWalletResp, error)
...
func (UnimplementedAggregatorServer) HideWallet(context.Context, *GetWalletReq) (*GetWalletResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method HideWallet not implemented")
}
func (UnimplementedAggregatorServer) UnhideWallet(context.Context, *GetWalletReq) (*GetWalletResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UnhideWallet not implemented")
}
...
func _Aggregator_HideWallet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetWalletReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AggregatorServer).HideWallet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Aggregator_HideWallet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AggregatorServer).HideWallet(ctx, req.(*GetWalletReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _Aggregator_UnhideWallet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetWalletReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AggregatorServer).UnhideWallet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Aggregator_UnhideWallet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AggregatorServer).UnhideWallet(ctx, req.(*GetWalletReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Aggregator_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "HideWallet",
			Handler:    _Aggregator_HideWallet_Handler,
		},
		{
			MethodName: "UnhideWallet",
			Handler:    _Aggregator_UnhideWallet_Handler,
		},
		{
