...
// The JSON catalog files are the only token-whitelist data committed to
// the repo (this fs.go is just the embed wiring); they're populated from
// `@avaprotocol/protocols` via `make sync-tokens` and a CI drift gate
// fails any hand-edit.
//
